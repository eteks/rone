...
jQuery(document).ready(function ($) {
    ...
    var    loaderLightbox = '<div class="landing landing-els lightbox"><div class="spinner"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></div></div>';
    ...
    var callback = function (playerShots) {
        ...
        $.each(playerShots.shots, function (i, shot) {
            html += '<div class="item column three"><div class="ip-slider">';
            html += '<img src="' + shot.image_url + '" ';
            html += 'alt="' + shot.title + '"></div>';
    ...
    function useMockup() {
        ...
        findDevice.each(function () {
            ...
            var $this = $(this),
                ...
                mockupslider = $this.children('.ip-slider'),
                autoplay = $this.data('autoplay');
    ...
    function gallerySlider() {
        ...
        galleryslidercontainer.each(function () {
            ...
            var $this = $(this),
                galleryslider = $this.children('.ip-slider'),
                autoplay = $this.data('autoplay'),
                autoheight = $this.data('autoheight');
