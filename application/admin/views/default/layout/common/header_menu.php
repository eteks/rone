...
<ul id="topbar" style="margin-top:5px; padding: 6px 11px;">
    ...
    <li class="s_1"></li>
        <li class="fr">Pay: <b><?php echo $site_setting->currency_symbol.$total_runner_pay; ?></b></li>
        <li class="s_1 fr"></li>
        
        <li class="fr">Escrow: <b><?php echo $site_setting->currency_symbol.$total_escrow; ?></b></li>
      
        <li class="s_1 fr"></li>
          <li class="fr">Earning: <b><?php echo $site_setting->currency_symbol.$total_earn;?></b></li>
      ...
      <ul id="navbar">
        ...
        <?php if($this->strdd[0] == 'user' || $this->strdd[0] == 'review') { ?>
         ...
         <?php } ?>
              ...
              <?php if($this->strdd[0] == 'transaction_type' || $this->strdd[0] == 'payments_gateways' || $this->strdd[0]=='wallet_setting'||$this->strdd[0] =='gateways_details' || $this->strdd[0] == 'transaction' || $this->strdd[0] == 'wallet_report' || $this->strdd[1] == 'list_wallet_review' || $this->strdd[1] == 'list_wallet_withdraw') { ?>
             
             <li class="active"><?php echo anchor('wallet/list_buy_credit','<span class="icon_text media"></span>Payment',' title="Payment Module"');?></li>
         ...
         <?php } else { ?>
         <li><?php echo anchor('wallet/list_wallet_withdraw','<span class="icon_text media"></span> Payment',' title="Payment Module"');?></li>
         <?php } ?>

      <!-- New -->
         <?php if($this->strdd[1] == 'list_buy_credit' || $this->strdd[1] == 'list_buy_creditonline') { ?>
             
             <li class="active"><?php echo anchor('wallet/list_buy_credit','<span class="icon_text media"></span>Credit Management',' title="Payment Module"');?></li>
             <ul>
             	<li <?php if($this->strdd[1] == 'list_buy_credit') { echo 'class="active"'; }?>><?php echo anchor('wallet/list_buy_credit','Credit by Paypal  ',' title="Credit by Paypal" class="subbutton white"');?></li>
             	<!---<li <?php if($this->strdd[1] == 'list_buy_creditonline') { echo 'class="active"'; }?>><?php echo anchor('wallet/list_buy_creditonline','Credit by stip  ',' title="Credit by stip" class="subbutton white"');?></li>-->
             </ul>
             
         <?php } else { ?>
         <li><?php echo anchor('wallet/list_buy_credit','<span class="icon_text media"></span>Credit Management',' title="Payment Module"');?></li>
         <?php } ?>
        ...
        <li><?php echo anchor('pages/list_members','<span class="icon_text content"></span>Credit Plans',' title="Credit Plans"');?></li>
         ...
         <?php /*?><?php if($this->strdd[0] == 'newsletter') { ?>
