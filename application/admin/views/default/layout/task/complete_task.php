...
function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo base_url();?>task/completed_task/'+limit;
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>task/completed_task/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
...
<div id="content">        
	...
	<div class="box">		
		...
		<h2 class="box-header">Completed Tasks </h2>
			...
			<table class="tablebox">
              ...
              <input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
               ...
               <?php echo anchor('task/export_compete_task/'.strtotime(date('H:i:s')),'Export CSV','class="button white" style="margin: 0px;"'); ?>
