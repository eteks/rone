<script type="text/javascript" language="javascript">
	...
	function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo base_url();?>task/list_task/'+limit;
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>task/list_task/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
			...
			<table class="tablebox">
                   ...
                   <!-- <div style="float:left; width:135px;">
                    ...
                    <div style="float:left; width: 770px;">
                     <form name="frm_search" id="frm_search" method="post" action="<?php echo base_url(); ?>task/search_list_task/<?php echo $limit; ?>" onSubmit="return chk_valid();">
				...
				<?php
                  ...
                  ?>
					<tr class="<?php echo $cl; ?>">
                        ...
                        <td><?php echo anchor('task/task_detail/'.$row->task_id,'View Detail','class="button white" id="task_'.$row->task_id.'"'); ?></td>
