<script type="text/javascript" language="javascript">
	...
	function getlimit(limit)
	{
		...
		{
			window.location.href='<?php echo base_url();?>worker/list_deleted_worker/'+limit;
		}
	...
	function getsearchlimit(limit)
	{
		...
		else
		{
			...
			window.location.href='<?php echo base_url();?>worker/list_deleted_worker/'+limit+'/<?php echo $option.'/'.$keyword; ?>';
		}
	...
	function gomain(x)
	{
		...
		if(x == 'all')
		{
			window.location.href= '<?php echo base_url();?>worker/list_deleted_worker';
		}
	}
...
<div id="content">        
	...
	<div class="box">		
		...
		<h2 class="box-header">Deleted Runners </h2>
			...
			<table class="tablebox">
               ...
               <form  name="frm_deleted" id="frm_deleted" action="<?php echo base_url();?>worker/delete_forever/" method="post">
               <input type="hidden" name="offset" id="offset" value="<?php echo $offset; ?>" />
               <input type="hidden" name="action" id="action" />
                <input type="hidden" name="fname" value="list_deleted_worker"/>
				
               <?php echo anchor('worker/export_deleted_worker/'.strtotime(date('H:i:s')),'Export CSV','class="button white" style="margin: 0px;"'); ?>
                
                 <a href="javascript:void(0)"  onclick="setaction('chk[]','delete', 'Are you sure, you want to delete selected record(s)?', 'frm_deleted')" class="button white" style="margin: 0px;"><span class="icon_text cancel"></span> Delete</a>
           ...
           <a href="javascript:void(0)" onClick="javascript:setchecked('chk[]',0)" style="color:#000;"><?php echo "Clear All"; ?></a></th>
                        ...
                        <th class="first tc">Runners Name</th>
