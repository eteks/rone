<script type="text/javascript" language="javascript">
	...
	{
		var ans = confirm("Are you sure to delete Membership plane?");
		if(ans)
		{
			location.href = "<?php echo base_url(); ?>pages/delete_member/"+id+"/"+offset;
		}else{
			return false;
		}
	}
...
<div id="content">        
	...
	<div class="box">		
		...
		<h2 class="box-header">Membership Plan
 </h2>
			...
			<table class="tablebox">
                ...
                <input type="hidden" name="action" id="action" />
				 &nbsp;<?php echo anchor('pages/add_members','<span class="icon_text addnew"></span>add new','class="button white"  style="margin: 0px;"'); ?>
				...
				<?php
					...
					<tr onClick="<?php echo $cl; ?>(this);" class="<?php echo $cl; ?>">
                        ...
                        <td class="tc"><?php echo $row->title; ?></td>
                        <td><?php echo $row->price; ?></td>
                        <td><?php echo $row->numbid; ?></td>
                        
                      	<!--<td><?php if($row->status=="1"){ echo "Active"; }else{ echo "Inactive"; } ?></td>-->
                      	<td><?php echo anchor('pages/edit_members/'.$row->id.'/'.$offset,'<span class="icon_single edit"></span>','class="button white"'); ?>  <a href="#" onclick="delete_rec('<?php echo $row->id; ?>','<?php echo $offset; ?>')" class="button white"><span class="icon_single cancel"></span></a></td>
