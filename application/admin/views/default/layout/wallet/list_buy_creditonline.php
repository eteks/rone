...
<div id="content">        
	...
	<div class="box">		
		...
		<h2 class="box-header">Buy Cradit List 
			...
			<table class="tablebox">
			 ...
			 <div style="float:right;">
               <form name="frm_listproject" id="frm_listproject" action="<?php echo base_url();?>wallet/action_credit_review" method="post">
                   	...
                   	if($result)
									{
                                        ...
                                        $packname=$this->wallet_model->getNameTable("trc_membership","title","id",$row->pack_id);
								  ?>
					<tr>
