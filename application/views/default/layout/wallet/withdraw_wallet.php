...
<div id="detail-bg2" class="padTB10">
    ...
    <div class="fl"> 
        ...
        Administrator Transaction Fees <b class="colblack"><?php echo $wallet_setting->wallet_donation_fees; ?>(%)</b> is added on the Total Withdrawal also Transaction Charges cut from the withdrawal Amount.<br />Minimum <b class="colblack"><?php echo  $site_setting->currency_symbol.$wallet_setting->wallet_minimum_amount; ?></b> is required.-->
         Transaction charge of <?php echo $site_setting->currency_symbol ?>10.00 Will be deducted from the withdrawal amount of less than <?php echo $site_setting->currency_symbol ?>300.00 <br />
         Minimum Withdrawal Amount <?php echo $site_setting->currency_symbol ?>80 is required.
	</div>
</div>
...
<tr>
    ...
    <p class="fs15">
      <label style="font-size:15px;">
        <input type="radio" name="withdraw_method" onclick="change_div_method(this.value)" value="bank"  <?php if($withdraw_method=='bank') { ?> checked="checked" <?php } ?> id="withdraw_method" /> By Banking</label>
     ...
     <!-- <label>
      ...
      <label style="padding-left:10px;">
        <input type="radio" name="withdraw_method" onclick="change_div_method(this.value)" value="gateway" style="margin-right:5px;" id="withdraw_method" <?php if($withdraw_method=='gateway') { ?> checked="checked" <?php } ?>  /> By Paypal </label>
