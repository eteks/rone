       ...
       <?php //echo anchor('wallet/my_withdraw','Withdrawal History','class="btn btn-default mar-bot-5"'); ?>
         <?php } ?>
			...
			<?php
				...
				echo form_open('wallet/buycredit',$attributes);
			?>
			...
			<input type="hidden" name="creditid" value="<?php echo $this->uri->segment(3, 0) ?>">
...
<div class="bye-credit-box">
    ...
    <div class="bye-price-tag">
    	<div class="Price-main">
            ...
            <div class="Price-main-amount">USD <?php echo $price; ?></div>
    ...
    <div class="bye-btns">
    	<div class="bye-btn-main">
            ...
            <div class="cancel-rpo">or <a href="<?php echo base_url()?>user_other/Buy_credit">Cancel Process</a></div>
        </div>
        <div class="clear"></div>
...
<tr>
    ...
    <p class="fs15">
      <label style="font-size:15px;">
            ...
            <img src="<?php echo base_url().getThemeName()?>/images/stripe_icon.png" class="credit_icon" style="vertical-align:middle; padding: 0 0 0 5px;">
      </label>
    </p>
	</td>
	</tr>        
