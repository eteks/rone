...
<div id="s1postJ" class="padB10">Conversation with: <?php echo anchor('user/'.$check_user_detail->profile_name,ucfirst($check_user_detail->first_name).' '.ucfirst(substr($check_user_detail->last_name,0,1)),' class="dhan" ');?></div>
