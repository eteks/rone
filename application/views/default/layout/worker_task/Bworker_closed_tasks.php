...
<div class="incon">
  ...
  <div class="padB20">
           ...
           <?php echo anchor('worker_task/assigned','Assigned','class="fpass fs14"');?>
           	...
           	<li>
           <?php echo anchor('worker_task/closed','Closed',' class="fpass fs14 act"');?>
           </li>
		...
		<div class="marTB5">
        	<div class="fl wid100 marL80">
             ...
             <div class="fr" >
    	        ...
    	        <?php echo anchor('worker_task/conversation/'.$row->worker_id.'/'.$row->task_id,'Conversation',' class="chbg"');?>
