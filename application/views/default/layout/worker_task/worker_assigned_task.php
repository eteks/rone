                  ...
                  <div class="mconright dbright-task-main-posted">
                      <div class="" style="text-align:center;">
                          ...
                          <div class="fleft100">
                              ...
                              <?php echo anchor('worker_task/assigned','Assigned','class="b-button b-button-2 selected-task" style="text-align:center; padding-left:0px;"');?>
    ...
    <li>
        ...
        <ul class="ulnobor">
          ...
          <p class="marB5"><span class="fpass fs14 colora"> Now you can start work.</span></p>
            ...
            <?php } elseif($assign_pay_status==0 && $assign_time_pay_amount==0 && $site_setting->transection_need==1) { ?>
