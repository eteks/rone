...
<div>
	<div>
    	...
    	<div class="red-subtitle top-red-subtitle">Closed Tasks</div>
                  ...
                  <div class="mconright dbright-task-main-posted">
                      <div class="" style="text-align:center;">
                          ...
                          <div class="fleft100">
                              ...
                              <?php echo anchor('worker_task/closed','Closed','class="b-button b-button-2 selected-task" style="text-align:center; padding-left:0px;"');?>
                          </div>
                      </div>
                  </div>
              </div>
            ...
            <div class="marTB5">
                <div class="fl wid100 marL80">
                 ...
                 <div class="fr" >
                    ...
                    <?php echo anchor('worker_task/conversation/'.$row->worker_id.'/'.$row->task_id,'Conversation',' class="btn btn-default"');?>
