...
<header>
<div class="container">
<div id="logo-placing"><a href="<?php echo base_url(); ?>"><img src="<?php echo base_url().getThemeName()?>/images/logo_new.png"></a></div>
...
<?php } else {?>
<div class="login-sigup login-sigup-db after-login">
    <div id="flag-ph"><!--<img src="<?php echo base_url().getThemeName()?>/images/flag.jpg">-->
	    <!--<span class="wallet_balance">Wallet Balance kr <?php echo getwallet_amount() ?></span>-->
    </div>
</div>
...
<li class="login-user-name"><?php echo $this->session->userdata('full_name'); ?></li>
                    ...
                    <?php if($site_setting->transection_need==1) { ?>
...
<div class="rmm login-sigup-2">
                            <ul>
								...
								?>
											<a href="javascript:void(0)" class="pupload13" >Post a Job</a>
				                ...
				                <li><a href="<?php echo base_url(); ?>task/all_task">Find a Job</a></li>
				                <li><a href="<?php echo base_url(); ?>index.php/who-are-the-taskers">Hire a Dronepilot</a>
				                </li>
