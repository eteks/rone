...
<div>
<div>
<div class="red-subtitle top-red-subtitle">Search</div>
...
<div class="home-signpost-content">
    	...
    	<div class="dbleft dbleft-main dbleft-main-1 " style="float:none; margin:auto; padding:0px !important; min-height:400px; ">
       	...
       	<div class="search-form">
            ...
            ?>
                <input type="text" name="search" id="search" class="hsearchbg1 hsearchbg1-1 fl" autocomplete="off" style="margin-top: 0px !important; width:190px; height:24px;"  placeholder="Enter your text search" onclick="this.placeholder=''" onblur="this.placeholder='Enter your text search'" value="<?php echo urldecode($search); ?>" />
                <input type="submit" class="btn btn-default fr" value="Search">
            </form>
        </div>
        <div class="clear"></div>
        ...
        <h3 id="detail-bg1"><span class="fl"> <?php echo $total_rows; ?> Jobs found</span><span class="fr"><?php if($total_rows != 0) { echo '1-'.$total_rows.' of '.$total_rows; }?></span><div class="clear"></div></h3>
        <div style="background:#e7e7e7; padding:15px; border-radius:10px; margin-top:20px;">
            <ul class="ulsty" >
                                 ...
                                 $user_image= base_url().'upload/no_image.png';
                                    ...
                                    <li>
                                        ...
                                        <div class="catle2 LH18 fl">
                                            ...
                                            <span class="colmark colmark-2">Jobs of this type: <?php echo $site_setting->currency_symbol.$row->task_to_price.' - '.$site_setting->currency_symbol.$row->task_price;?></span>
                                            <br />
                                     ...
                                     {  
                                        echo anchor('sign_up','Post Similar Job',' class="btn btn-default" ');  
                                     }  
                                     else 
                                     { 
                                        if($site_setting->subscription_need==0)
                                        {
                                        echo anchor('task/update_task_step_zero/'.$row->task_id.'/copy','Post Similar Job',' id="copytask_'.$row->task_id.'" class="btn btn-default" '); ?>
                                    ...
                                    <?php 
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                            ?>
                                            <a href="javascript:void(0)" class="btn btn-default pupload13"><b>Post Similar Job</b></a>
                                            <?php
                                            }
                                        }
