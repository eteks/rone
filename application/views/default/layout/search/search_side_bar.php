 <div class="mconright">
        ...
        <li><div class="estim marB5" style="padding-left: 50px;">Viewing Task in Boston</div>
        
        	<ul class="ulmycity" style="padding-left:50px">
            <li>
				<?php 
                    if($cityname == 'all') {
           ...
           <?php } $cityi++; } } ?>
			...
			if($worker_list){
				...
				if($row != 0) {  $worker_cnt++; } } }  echo $worker_cnt;?> Worker bees found</span><span class="fr fs13 marT2"></span><div class="clear"></div></h3>
        	...
        	<li class="posrel">            
                       ...
                       <div class="ponleft">
						...
						echo anchor('user/'.$worker->profile_name,'<img src="'.$user_image.'" width="50" height="50" alt=""/>');?>
                            <a rel="tooltip" class="twoonepts1" title="Level <?php echo $worker->worker_level; ?> Worker bee"><?php echo $worker->worker_level;?></a>
                       </div>
                       <div class="ponright">
...
<?php } ?>
			 ...
			 foreach($ex_type as $type) 
			 {
				 ...
				 if($get_task_type)
				 {
					...
					if($task_type_detail!='') { echo  substr(substr($task_type_detail,0,-1),0,20).'...'; }  }
