                ...
                <div class="imgleft"  style="position:relative;">
                  ...
                  <img src="<?php echo base_url(); ?>upload/no_image.png" width="72" height="72" alt="" class="fl"  />
                    ...
                    ?>
                        ...
                        <a rel="tooltip" id="twoone1br" title="Level <?php echo $check_worker_detail->worker_level;?> Runner"><?php echo $check_worker_detail->worker_level;?></a>
            ...
            foreach($activities as $res)
            {
				...
				switch ($act)
				{
						case 'signup':
						  ...
						  ?>
							...
							if(isset($custom_msg)) { if($custom_msg!='') { ?>
							 ...
							 <a id="twoonebr1" rel="tooltip" title="Level <?php echo $custom_msg;?> Runner"><?php echo $custom_msg; ?></a>
						...
						case 'posttask':
						 ...
						 <li class="posrel">
							...
							if(isset($key_id)) { if($key_id!='') {
							 ...
							 <a id="twoonebr1" rel="tooltip" title="Level <?php echo $key_id;?> Runner"><?php echo $key_id; ?></a>
                        ...
                        <li class="posrel">
							...
							$worker_level=0;
							 ...
							 <a id="twoonebr1" rel="tooltip" title="Level <?php echo $worker_level;?> Runner"><?php echo $worker_level; ?></a>
                   ...
                   <?php 
						...
						if(isset($custom_msg)) { if($custom_msg!='') {
							...
							if(isset($comment_level)) { if($comment_level!='') {
							 ...
							 <a id="twoonebr1" rel="tooltip" title="Level <?php echo $comment_level;?> Runner"><?php echo $comment_level; ?></a>
               ...
               $user_image= base_url().'upload/no_image.png';
							...
							echo anchor('user/'.$profile_user_url_name,'<img src="'.$user_image.'" alt="" width="30" height="30" />'); 
							 ...
							 <a id="twooneanj" rel="tooltip" title="Level <?php echo $key_id;?> Runner"><?php echo $key_id; ?></a>  
                             <?php }  } ?>
