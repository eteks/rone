...
<?php } ?>
  ...
  <div class="padB20">
          	<div class="marB10">
	            <div class="inside-subtitle">Account Information <?php echo anchor('user/edit','Edit','class="btn btn-default btn-edit fr"');?></div>   
				<div class="account-det">
                    <div class="fleft100">
                        <div class="acc-subtitle acc-subtitle-1"><div class="acc-subtitle-1-title fl">Name:</div> <?php echo $user_info->first_name.' '.$user_info->last_name; ?></div>
                    </div>
                    <div class="fleft100 mtop5">
                        <div class="acc-subtitle acc-subtitle-1"><div class="acc-subtitle-1-title fl">Email:</div> <a href="mailto:<?php echo $user_info->email; ?>" class="fpass"><?php echo $user_info->email; ?></a></div>
                    </div>
                    <div class="fleft100 mtop5">
                        <div class="acc-subtitle acc-subtitle-1"><div class="acc-subtitle-1-title fl">Document Id: </div><?php if($user_info->zip_code=='') { echo anchor('user/edit','add','class="fpass"'); } else { echo $user_info->zip_code; } ?></div>
                    </div>
                    <div class="fleft100 mtop5">
                        <div class="acc-subtitle acc-subtitle-1"><div class="acc-subtitle-1-title fl">Phone: </div><?php echo $user_info->mobile_no; ?></div>
                    </div>          
                </div>
			</div>           
...
<!--<div class="marTB10">
                ...
                <div class="inside-subtitle">My Saved Locations <?php echo anchor('user_other/locations','Edit','class="btn btn-default btn-edit fr"');?></div>
