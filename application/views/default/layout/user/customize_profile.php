...
<div>
<div>
<div class="red-subtitle top-red-subtitle">Improve profile : <?php echo $user_profile->first_name.' '.substr($user_profile->last_name,0,1); ?></div>
 ...
 $image_settings=image_setting();
	...
	?>
     ...
     <div class="clear"></div>
        ...
        <?php echo anchor('user/upload_photo','<img src="'.base_url().getThemeName().'/images/camera.png" width="20" height="20"   alt="" />&nbsp;Add a photo',' id="pupload" class="fpass"');?>
         </td>
         ...
         <td width="80%" valign="top">
          ...
          <!--<p class="colblack">My City : 
           ...
           <?php } ?>
          	...
          	<div class="marTB10">
              <fieldset>
           <div class="inside-subtitle">Tell employer about yourself</div>
...
<div class="marTB10">
              ...
              <fieldset>
            <div class="padB10"><div class="inside-subtitle">Upload your Portfolio here</div></div>
...
<?php echo anchor('user/user_video','Add Videos','id="user_video" class="btn btn-default"');?>
<?php echo anchor('user/upload_portfolio','Add Images','id="upload_portfolio" class="btn btn-default marL5"');?>
...
?>
 ...
 <div align="center" class="btn-480" style="padding-left: 00px;">
        <input type="submit" name="customizebtn" id="customizebtn" value="Save Changes" class="btn btn-default btn-post"  />
        </div>
