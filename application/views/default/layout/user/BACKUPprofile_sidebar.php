        ...
        <div class="mconright">
              ...
              <?php if($user_profile->user_id==get_authenticateUserID()) { ?>
                ...
                <div class="marTB5">
              <?php echo anchor('customize_profile','Customize Profile','class="ncitybg"'); ?>
                        </div>   
                           <div class="roboimg marTB20" >&nbsp;</div>
                ...
                <?php } else { 
                 ...
                 $check_worker_detail=$this->worker_model->check_user_worker_detail($user_profile->user_id);
                    ...
                    ?>
                        <div class="marTB5">
                   <?php  if(!check_user_authentication()) {  echo anchor('sign_up','Hire '.$user_profile->first_name,'class="ncitybg"');   }  else {
				   
				   
				 echo   anchor('task/new_task/'.$check_worker_detail->worker_id,'Hire '.$user_profile->first_name,'class="ncitybg" id="hireme_'.$check_worker_detail->worker_id.'"');
            ...
            <div class="estim marB10 padT15">Top Task Types</div>
            <div class="types">
                <ul>
...
?>
    ...
    <div class="rate"><h6><?php echo $total_rate; ?>/5  ( <span><?php echo anchor('user/'.$user_profile->profile_name.'/reviews',$total_review.' reviews');  ?> </span> )</h6></div>
    <div class="clear"></div>
</div> 
...
<div class="rlist" >
	...
	if($reviews ) { 
        ...
        <li>
            <h5><span><?php echo anchor('user/'.$user_profile->profile_name.'/reviews','see all review');?></span></h5>
        </li>
     </ul>
</div>
