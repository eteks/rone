...
<div>
    ...
    <div class="red-subtitle top-red-subtitle" >Favourite Taskers: <?php echo anchor('user/'.getUserProfileName(),$this->session->userdata('full_name'),' style="color:#fff" ');?></div>
...
?>
                        <td width="58%">
                        	<div class="strmn strmn-2" style="margin-top:2px;"><div class="str_sel str_sel-2 fl" style="width:<?php if($total_rate>5) { ?>100<?php } else { echo round($total_rate*2);?>0<?php } ?>%;"></div></div><div class="fl marL5"><?php echo $total_rate; ?>/5(<?php echo anchor('user/'.$row->profile_name.'/reviews',$total_review.' reviews','class="fpass"');  ?>)</div></td>
                        <td width="20%">
                                       
                                       
                                    
                                        
                                <?php echo anchor('user_other/delete_favorite/'.$row->favorite_id.'/'.$offset,'Unfavorite','class="btn btn-default btn-color fr"'); ?>
