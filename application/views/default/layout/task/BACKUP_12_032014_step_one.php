                ...
                <div class="inner_content_two">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                      <tr id="address1TR">
						...
						<td><input name="address1" id="address1" type="text" size="22"  placeholder="Enter a location" /><span id="address1_symbol" style="float:right; height:30px;"></span><br /><span id="address1Info" style="height:5px;"></span></td>
                      </tr>
                      <tr id="zipcodeTR">
						<td valign="top"><label>Postal Code</label> <span id="req" style="color:red;">*</span></td>
						<td><input name="zipcode" id="zipcode" type="text" size="22" placeholder="Postal Code"  /><span id="zipcode_symbol" style="float:right; height:30px;"></span><br /><span id="zipcodeInfo" style="height:5px;"></span>
...
margin-bottom: 6px;">How much are you willing to pay for this Task?</label>
              ...
              <table width="100%" border="0" cellspacing="1" cellpadding="5">
               <tr><td id="task_to_priceTR" width="25%"><b class="fs15">From <span id="req" style="color:red;">*</span>&nbsp;&nbsp;&nbsp;</b><span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="task_to_price" id="task_to_price" type="text" size="5" value="<?php if($task_to_price==0.00 || $task_to_price==0) { } else { echo $task_to_price; } ?>" />&nbsp;&nbsp;<span id="task_to_price_symbol" style="float:right; height:30px;"></span><br /><span id="task_to_priceInfo" style="height:5px;"></span></td>
 
                
              <td id="task_priceTR" width="28%" style="padding-right: 10px;"><b class="fs15">To <span id="req" style="color:red;">*</span>&nbsp;&nbsp;&nbsp;</b> <span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="task_price" id="task_price" type="text" size="5" value="<?php  if($task_price==0.00 || $task_price==0) { } else { echo $task_price; } ?>" /><span id="lesf"><?php echo $site_setting->currency_symbol;?><?php echo $task_detail->category_average_price; ?></span><span id="task_price_symbol" style="float:right; height:30px;"></span><br /><span id="task_priceInfo" style="height:5px;"></span></td>
				<td width="60%"> is the average price for similar Tasks</td></tr></table>
