...
<?php 
	$attributes = array('name'=>'askQuestionForm','id'=>'askQuestionForm','class'=>'form_design');
	echo form_open('task/ask_question/'.$task_id,$attributes);
?>
...
<table  border="0" cellspacing="1" cellpadding="5">
  ...
  <tr id="task_commentTR">
	<td width="82%">
		...
		<textarea name="task_comment" id="task_comment" cols="73" rows="5" style="margin-top:5px; width:352px; height:100px; " class="form-control form-control-1" ><?php echo $task_comment; ?></textarea><br />
   ...
   <tr>
	<td width="82%" style="text-align:center;">
		...
		<input type="submit" value="Send Message" class="btn btn-default" name="askQuestionbtn" id="askQuestionbtn">
