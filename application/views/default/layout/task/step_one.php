                    	...
                    	<div class="left-part">
                            ...
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div id="container-cat-fancy" class="bottom-selection" style="margin-top:0px; padding-top:0px;">
									...
									<option value="" <?php if($task_category_id=="") { ?> selected <?php } ?>>--Please select a category--</option>
                                        <?php 
                                        $cat_arr=array();
                            ...
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="step-2-info">
                                    ...
                                    <!--<a href="javascript:void(0);" id="prino"  class="fl marL5 questions normalTip" title="Use private notes for sensitive info. Private notes will be shared only with the assigned Taskit"></a>-->
                                </div>
                            </div>
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="">
							...
							<div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="5" style="margin-left:-1px;">
                                        <tr>
                                            <td class="firts_img-1">Actual Image of task:</td>
                                        </tr>
                                        <tr id="task_nameTR">
                                            <td>
                                                
                                                <input name="task_img" type="file" class="right_round" style="margin-bottom:0px; float:left;" id="task_img"/>
                                                <span id="task_name_symbol" style="float:left; height:30px; margin-left:5px;"></span><br />
                                                <span id="task_nameInfo" style="height:5px;"></span>
                                            </td>
                                        </tr>
                            ...
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="left-online">
                                    <div class="firts_img-1 firts_img-1-320">Can it be done online?</div>
                        ...
                        <div class="right-part">
                                    ...
                                    <div class="implcr wid550 LH23" style="margin-top:10px; width:100%; margin-bottom:20px;">
                                          <div class="clear"></div>
                                              <table width="" border="0" cellspacing="1" cellpadding="5" class="price_info">
                                                  <tr>
                                                      <td class="firts_img-1 yes-no-section-1 right_round"><div style="padding-right:0px; padding-top:6px; text-align:center;"><?php echo $site_setting->currency_symbol ?></div></td>
                            ...
                            <div class="margin-between"></div>
                                ...
                                <div class="" style="text-align:right;">
                                    <input type="submit" name="sub_step1" class="btn btn-default btn-post-btn btn-default-join-hiw" id="post_new_task" value="Save & Continue" style="margin-top:0px;">            
