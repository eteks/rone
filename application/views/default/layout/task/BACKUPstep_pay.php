...
<div class="tabs2">
            ...
            <h3 class="crec fs14">Credit card <span id="req" class="crec1" >Your card will not be charged until the Task is complete. <a href="#learnmoreinfo" id="learnmore">Learn more</a></span> </h3>
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
  ...
  <?php  } ?>
             ...
             <span id="ac">You can review your Task and make changes before Posting. 
			 <input type="submit" value="Post Task" class="submbg2" name="sub_step2"></span>   
...
<div class="borrdercol marT10">
    ...
    <div class="addtrr" ><?php echo anchor('task/step_one/'.$task_id,'Edit Task', 'class="chbg marTB10"');?></div>
	<div class="clear"></div>  
