...
/*e*/
  ...
  function fr_check()
  {
  	...
  	//alert(address1.val());
  	//return false;
	if($('input[name=user_location_id[]]:checked').length >1)
	{
		//alert($('input[name=user_location_id[]]:checked').length);
		return true;
	}
...
<div class="db-rightinfo-dash db-rightinfo-dash-back">
    <div class="container">
        ...
        <div class="home-signpost-content dashboard-box1 dashboard-box2 round-back">
        	<h1 class="social-login-title" style="padding:10px 0 0 0;"><b style="color:#ec6600;">Get FREE Quotes</b></h1>
            <div class="fleft100 mtop15" >
                ...
                <div class="main-selection">
                	<div id="container-cat-fancy" class="bottom-selection " style="margin-top:0px; padding-top:0px; padding-left:0px; background:none;">
                        <span class="select_box select-title"><strong>Please Select a Job Category</strong></span>  
                        <?php
						$path = $_SERVER['REQUEST_URI'];
						$pathFragments = explode('/', $path);
						$end = end($pathFragments);
						?>
                        <select name="task_category_id" class="form-control select-width select-new-cate" >
                        <?php 
                        $cat_arr=array();
                        if($categories){ $ic=1; $putval=0;
                            foreach($categories as $c){
                        ?>
                            <option value="c<?php echo $c->task_category_id; ?>" <?php if("c".$c->task_category_id==$end) echo "selected" ?>><?php echo ucfirst($c->category_name); ?></option>
                        <?php
                            }
                        }
                        ?>		
                    ...
                    <div class="top-selection" style="margin-top:10px;">
                        <div class="fl">
                        	<span class="select_dop_name select-title" style="width:auto;"><strong>Where do you want this done? </strong></span>
                        </div>
                        <div class="fl">
                    ...
                    <div class="top-selection">
                    	<!--<div class="fl">
                        	<span class="select_dop_name select-title"><strong>Please Select a location :</strong></span>
                        </div>-->
                        <div class="fl">
                            <select name="task_city_id" id="task_city_id" class="selboxwi200 select_dop_name_box form-control select-width" title="Please select a location" style="margin-top:0px;">
                    ...
                    <div class="fl" style="margin-bottom:8px;">
                        <span class="select_dop_name select-title"><strong>Address </strong></span>
                    </div>
                    <div class="">
                        ...
                        i.style.display="none";
                          ...
                          google.maps.event.addDomListener(window, 'load', initialize);
                            ...
                            <div id="add_new_address" class="need_help"><a href="javascript:void(0)" style="text-decoration:underline;"><b>Add new address</b></a></div>
                                ...
                                <ul id="add_more2">
                                    <li id="more2" >
                                        <div class="addleft LH30" >
                                            ...
                                            <!--  <tr id="zipcodeTR">
                                                <td valign="top" style="padding-bottom: 5px"><label class="main-title">Post Code : </label></td>
                                              </tr>
                                              <tr>
                                                <td><input name="zipcode" id="zipcode" class="form-control add-text" style="float:left;" type="text" size="18" placeholder="Post Code"  />
                                                    <input type="hidden" name="location_state" id="location_state" value=""/>
                                                    <input type="hidden" name="location_city" id="location_city" value=""/>
                                                </td>
                                              </tr>-->
                                              <tr id="locationnameTR">
                                                <td valign="top" style="padding-bottom: 5px"> <label class="main-title">Location name : </label></td>
                                              </tr>
                                              <tr>
                                                <td><input name="locationname" id="locationname" class="form-control add-text" style="float:left;" type="text" size="18" placeholder="Home,Sally's,etc"/><?php $location_cnt = 1; ?>
                                                </td>
                                              </tr>
                                             
                                              <tr>
                                                <td colspan="2">
                                                  <label class="main-title" style="font-weight:normal; padding:0px; margin-bottom:0px; font-size:15px;"><input type="checkbox" name="savelocation" value="<?php echo $location_cnt;?>" id="savelocation" /> &nbsp; Save this location </label>
                                                </td>
                                              </tr>
                                            </table>
                                        </div>
                ...
                <div class="button-main" style="text-align:right; padding:20px 10px 10px 0;">
                    <input name="sub_step" class="btn btn-default find-friends-btn btn-default-join-hiw" value="Save &amp; Continue" type="submit" style="">    
