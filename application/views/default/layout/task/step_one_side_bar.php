...
<!--<div id="needhelp-ph">
	<div class="inside-subtitle inside-subtitle-12">Task needs to be done by </div>
                    ...
                    <li id="sline" class="LH20" style="display:block; clear:both; padding:0px; margin-bottom:20px;" >
                        ...
                        <div class="confi">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="" style="float:left; clear:both;">
                                <tr>
                                  <tr>
                                    <td height="40px" class="task-data-title" style="color:#585858;">I need this Task done by</td>
                                    <td height="40px" class="task-data-title" style="color:#585858;">Please Select Time</td>
                                  </tr>	
                                </tr>
                                <tr>
                                ...
                                <td class="text-done-1">
                                        <input type="text" class="form-control text-done select-width-4" name="task_end_time" id="task_end_time" value="">
                                </td>
                                  <!--<td>
