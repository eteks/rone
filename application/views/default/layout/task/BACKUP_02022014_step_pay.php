...
<div class="fleftfw" style="text-align:center"><img src="<?php echo base_url().getThemeName(); ?>/images/2n.png"></div>       
...
<table width="100%" border="0" cellspacing="1" cellpadding="3">
  ...
  <?php  } ?>
              <table width="100%" border="0" cellspacing="1" cellpadding="3">
             <tbody><tr><td>
			 <input type="submit" value="Post Task" class="submbg2" name="sub_step2">
               </td></tr>
  <tr><td>
...
<div class="borrdercol marT10">
    ...
    <div class="addtrr" ><?php echo anchor('task/step_one/'.$task_id,'Edit Task', 'class="chbg1 marTB10"');?></div>
	<div class="clear"></div>  
