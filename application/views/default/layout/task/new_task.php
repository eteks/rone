	 ...
	 if($cat_id=='') { 
	 	...
	 	if($categories){
					...
					if($c->category_image!='') {  
						...
						if(file_exists(base_path().'upload/category/'.$c->category_image)) { 
							
							$category_image=base_url().'upload/category/'.$c->category_image;
...
<div class="main_new_task" style="width:auto;">
...
<?php $cities=city_list(); ?>
    ...
    <div class="red-subtitle top-red-subtitle" style="border-radius:10px 10px 0 0 ;">Post a Job in</div>
    <div style="background:#e7e7e7; border-radius:0 0 10px 10px;">
    
    <div style="text-align:center;">
        <select name="task_state_id" id="task_state_id" class="selboxwi200" style="margin-top: 35px; border:1px solid #ccc;" onchange="get_city(this.value)">
    ...
    ?>
        ...
        <select name="task_city_id" id="task_city_id" class="selboxwi200" style="margin-top: 35px; border:1px solid #ccc;">
...
<table width="260" align="center" border="0" cellspacing="1" cellpadding="5" style="margin:auto;">
<tr>
<td width="10" align="right"><img width="20" height="20" border="0"  alt="" src="<?php echo base_url().getThemeName(); ?>/images/category.png"></td>
<td width="200" class="selsect_cate" style="font-size:15px;" align="left"><b class="colblack marL10" style="color:#ec6600;">Category Selected</b> : </td>
<td width="90" class="select_resutl" style="text-align:center;"><img src="" width="60" height="60" alt="" border="0" id="selcatimg" /><br /><span id="results"></span></td>
</tr>
</table>
...
<!--<div class="underl">
      ...
      <tr>
        ...
        <td width="78%"><div id="hideauto">
		 ...
		 if($task_detail->task_auto_assignment==2 ) { ?> 
           ...
           <a href="javascript:void();"  class="fpass" id="changeauto1"> Let me </a>  review the Runner who make offers 
         ...
         We'll <a href="javascript:void();"  class="fpass" id="changeauto1">   auto-assign</a> the Runner who makes the best offer
            ...
            <ul>
                 <li style="position:relative;">
                       ...
                       <label id="dibs1" class="curp fl">
                         ...
                         Auto-assign the Runner who makes the best offer</label> <a href="javascript:void();" id="showp1" class="fl marTL5"><div class="questions" ></div></a>
    ...
    <div id="dialog-form-p1">
        ...
        <p class="lineh17 padTB3">The quickest way to get stuff done: We'll automatically assign the Runner who makes the best offer. You sit back and let us take care of everything.</p>
    </div>
                      <div class="clear"></div>       
                 </li>
               ...
               <label id="dibs2"  class="curp fl">
                 ...
                 Let me review the Runner who make offers</label> <a href="javascript:void();" id="showp2" class="fl marTL5" ><div class="questions" ></div></a><div class="clear"></div>
    ...
    <div id="dialog-form-p3">
        ...
        <p class="lineh17 padTB3">The Runner you choose will have a period of exclusivity where only he or she can be assigned. If your chosen Runner does not respond, the exclusivity is lifted and it's up for grabs. You will be able to accept or decline offers from other Runners.</p>
    </div>             
...
<div class="padTB10 submit-btn-in" style="text-align:center;">
                <input name="sub_step" class="btn btn-default" value="Save &amp; Continue" type="submit">    
                <input type="hidden" name="task_id" id="task_id" value="<?php echo $task_id; ?>" />   
                <input type="hidden" name="copy" id="copy" value="<?php echo $copy; ?>" />   
				<input type="hidden" name="task_invit_worker" id="task_invit_worker" value="<?php echo $task_assign_worker; ?>" />    
