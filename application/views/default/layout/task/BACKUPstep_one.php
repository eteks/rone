...
<div class="tabs1">
          <div class="under">
            <table width="100%" border="0" cellspacing="1" cellpadding="5">
              ...
              <tr>
                <td width="82%"><label> Task Title</label> <span id="req">Required</span><br/>
				<input type="hidden" value="<?php echo $task_id;?>" id="task_id" name="task_id" />
                <input name="task_name" type="text" class="ntext" value="<?php echo $task_name;?>" id="task_name"/></td>
              </tr>
            </table>
			</div>
            ...
            <div class="fl"><label>Task Description</label>  <span id="req">This description is <b>public.</b></span><span > <a href="javascript:void(0);" id="addpnote" class="fpass">Add private notes</a></span></div>
            <a href="javascript:void(0);" id="prino"  class="fl marL5"><div class="questions"></div></a>
            <div class="clear"></div>
            <textarea name="task_description" id="task_description" cols="73" rows="5"><?php echo $task_description;?></textarea>
...
<div id="dialog-form-sprino">
                ...
                <p class="padTB3">Use private notes for sensitive info. Private notes will be shared only with the assigned Runner.</p>
            </div>            

            
            <div id="showpnote" style="display:none;">
            <label>Private Notes</label>
            <textarea name="more_details" id="more_details" cols="73" rows="2" placeholder="These may include where you want a package dropped off if you're not home, where you've hidden a key for a Runner, a FedEx account number, etc."><?php echo $more_details;?></textarea>
			...
			<div class="under">
            	...
            	<div class="implcr wid550" style="float:left;">
                	...
                	<span id="req" class="lockbg">Full addresses shared only with the assigned Runner</span>
	 ...
	 <script type="text/javascript">
      ...
      google.maps.event.addDomListener(window, 'load', initialize);
                ...
                <div class="inner_content_two">
                    <ul id="add_more2">
                        <li id="more2" >
                            <div class="addleft LH30" style="float:left;">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                      ...
                      <tr>
                        <td><input name="address1" id="address1" type="text" size="20"  placeholder="Enter a location" />
                     
             
                         <input type="hidden" name="location_state" id="location_state"   value=""/>
                          <input type="hidden" name="location_city" id="location_city"   value=""/>
                        </td>
                        <td><input name="zipcode" id="zipcode" type="text" size="8" placeholder="Postal Code"  /></td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td colspan="2"><input name="locationname" id="locationname" type="text" size="30" placeholder="Home,Sally's,etc"/>
										<?php $location_cnt = 1; ?>
									</td>
                      </tr>
                      <tr>
...
<div class="addright" style="float:left;">
	<!--<a href="javascript:void();" onclick="remove_div2(this)" class="fpass fr"><div class="closebg"><span class="padL15">remove</span></div></a>--><br/><div class="clear"></div>
...
<div class="clear"></div>
            ...
            <div class="under posrel">
            	<div class="implcl" style="float:left;">
                	 <img src="<?php echo base_url().getThemeName(); ?>/images/credit_card.png" width="48" height="40" alt=""   />
                </div>
            	<div class="implcr wid550 LH23" style="float:left;">
                <label class="fl">How much are you willing to pay for this Task?</label>
				...
				<div id="dialog-form-stp" class="fs11 LH18">
                    ...
                    <p>Your Task will be visible only to Runner.</p>
               ...
               <b class="fs15">From&nbsp;&nbsp;&nbsp;</b><span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="task_to_price" id="task_to_price" type="text" size="5" value="<?php if($task_to_price==0.00 || $task_to_price==0) { } else { echo $task_to_price; } ?>" />&nbsp;&nbsp;
 
                
              <b class="fs15">To&nbsp;&nbsp;&nbsp;</b> <span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="task_price" id="task_price" type="text" size="5" value="<?php  if($task_price==0.00 || $task_price==0) { } else { echo $task_price; } ?>" />
                <span id="lesf"><?php echo $site_setting->currency_symbol;?><?php echo $task_detail->category_average_price; ?></span> is the average price for similar Tasks<br/>
                <span id="req" class="lockbg">Your price is private and helps us determine when Runner make good offers    </span>
                </div>
                <div class="clear"></div>
            </div>  
            ...
            <div class="under posrel">
                ...
                <div class="implcr wid550 LH23" style="float:left;">
                <label class="fl">Extra Costs</label>
                ...
                <span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="extra_cost" id="extra_cost" type="text" size="5" value="<?php echo $extra_cost;?>" />
            ...
            <div class="marTB10">
<input type="submit" name="sub_step1" class="submbg2" value="Save & Continue">            
<span id="req" class="ie7sp9">Next step: Review your Task before posting.</span>
</div>
