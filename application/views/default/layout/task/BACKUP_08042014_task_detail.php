...
<div class="incon" style="margin:0 0 0 15px;">
    	<div class="mconleft">
				 	...
				 	if(get_authenticateUserID() != $task_detail->user_id) { 
						...
						if($get_worker_bid)
						{
						 ...
						 if($task_detail->task_activity_status==0) {
							 ...
							 echo anchor('task/offer_task/'.$task_id,'<b>Place Bid</b>',' id="offer_task" class="cm chbg" ');
...
<div class="marB20">
               ...
               <div class="fl marT_10" >
                ...
                echo anchor('task/post_message/'.$task_id.'/'.$comment->task_comment_id,'Reply',' id="postmessage_'.$comment->task_comment_id.'" class="chbg" ');
...
<div class="marB20">
          ...
          <p class="marB5"><b>Offer Amount : </b><span class="fpass fs14 colora"><?php echo $site_setting->currency_symbol.$offers->offer_amount; ?></span></p>
        	...
        	<div class="fl wid100 marL100">
                         ...
                         <div class="runlright" style="width: 58%;">
             ...
             <?php if($task_detail->task_activity_status==0 ) { echo anchor('task/accept_offer/'.$task_id.'/'.$offers->task_comment_id,'Accpet Offer',' class="chbg" '); }
			 
			 
			 if($task_detail->task_activity_status==1 && $task_detail->task_worker_id==$offers->worker_id) {
			 
			  echo anchor('user_task/complete/'.$task_id,'Complete Task',' class="chbg" '); 
