  ...
  ?></p>
     ...
     <?php   if($task_detail->task_activity_status==0) {
        ...
        <?php } } } } ?>
        	...
        	<div class="marB20">
            <center>
            I want to get this done, too!<br/><br/>
          
            
            
             <?php if(!check_user_authentication()) {  echo anchor('sign_up','<b>Use Task Template</b>',' class="login" ');  }  else { echo anchor('task/update_task_step_zero/'.$task_detail->task_id.'/copy','<b>Use Task Template</b>',' id="copytask" class="login" '); ?>
				...
				$user_image= base_url().'upload/no_image.png';
				 ...
				 if($worker_info->profile_image!='') {  
					...
					?>
                     ...
                     <br /> 
                     <div class="estim marB10 colgreen fs14"><?php echo $this->task_model->count_total_offer_on_task($task_id);?> Runner(s) submitted offer(s) on this Task</div>
                  <br />

                    <div class="estim marB10">Runners for this Task</div>
                     <div class="posrel marTB10">
                       <div class="ponleft">
                           <?php echo anchor('user/'.$worker_info->profile_name,'<img src="'.$user_image.'" width="50" height="50" alt=""/>'); ?>
                            <a rel="tooltip" class="twoonepts1" title="Level <?php echo $worker_info->worker_level;?> Runner"><?php echo $worker_info->worker_level;?></a>
                       </div>
                       <div class="ponright">
		   ...
		   if($task_detail->task_is_private==0 || $task_detail->user_id==get_authenticateUserID() || $task_detail->task_worker_id==$login_worker_id) {  
            ...
            <div class="marB20">
                <div class="estim marB10">Share with Friends</div>
                            ...
                            <a href="javascript:void()" onClick="window.open('http://www.mixx.com/submit?page_url=<?php echo site_url('tasks/'.$task_detail->task_url_name);?>&amp;title=<?php echo $task_detail->task_name; ?>','Share on Mixx','height=300,width=600,top=50,left=300');"><img src="<?php echo base_url().getThemeName(); ?>/images/m.png" alt=""  /></a>
			</div>
