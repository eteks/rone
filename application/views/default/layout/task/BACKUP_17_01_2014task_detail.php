...
<?php if($msg!='') { 
			...
			if($msg=='no') { 
?>
<div id="error"><ul><p>You have not sufficient amount to assign task to a Runner.</p></ul></div>
...
<div id="success"><ul><p>Task has been assigned to a Runner successfully..</p></ul></div>
...
<?php   if(check_user_authentication()) { 
			...
			/*	if(get_authenticateUserID() == $task_detail->user_id && $task_detail->task_activity_status==0 ) { 
				...
				<div class="marB20">
                <h3 id="detail-bg1">Detail</h3>
                
                
                <div class="marLR10">
                    <div><h4 class="fs13"><b>City : </b> &nbsp;&nbsp;&nbsp;<span id="need" style="font-weight:normal;"><?php echo ucfirst($task_detail->city_name); ?></span></h4></div>
                    <br>       
				...
				echo 	ucfirst($task_description);?></span><br><br>
...
<div class="marB20">
                <h3 id="detail-bg1">Conversations</h3>
                <ul class="ulsty2">
				<?php 
				$i= 0;
                ...
                <div class="top_paper"></div>
                <div class="papers">
                <div class="fl wid90 marL5">
                ...
                <a rel="tooltip" id="twoone2br" title="Level <?php echo $check_worker_detail->worker_level;?> Runner"><?php echo $check_worker_detail->worker_level;?></a>
                ...
                <div class="fl wid450" >
                <div style="margin-top:7px; margin-bottom:5px;" ><?php echo anchor('user/'.$comment->profile_name,'<b>'.ucfirst($comment->first_name).'</b> '.ucfirst(substr($comment->last_name,0,1)),' class="col fs14 unl"'); ?></div>
                <div style="font-size:1.25em; line-height:25px;">
                <p class="colmark"><?php echo $comment->task_comment;?></p>
                <p><?php echo getDuration($comment->comment_date,$task_id); ?></p>
                </div>
                </div>
                ...
                <li>
                    <div class="abct3" style="width:100px;">
					     ...
					     <?php echo anchor('user/'.$offers->profile_name,'<img src="'.$user_image.'" alt="" width="68" height="69"/>', 'class="fpass fs13" ');?>
                           ...
                           <a rel="tooltip" id="twoone2br" title="Level <?php echo $offers->worker_level;?> Runner"><?php echo $offers->worker_level;?></a>
           ...
           <div class="taskoneN1">
                <div class="taskoneleft">
                 ...
                 <div class="taskoneright">
                    <div><?php echo anchor('tasks/'.$task_info->task_url_name,ucfirst($task_info->task_name),' class="fpass"');?></div>
                    <h4><span class="nelly">posted by <?php echo '<b>'.ucfirst($task_info->first_name).' '.ucfirst(substr($task_info->last_name,0,1)).'.</b>'; ?></span> <span class="newyorkc">in <?php echo $task_info->city_name; ?></span></h4>
                    <h4><span class="nelly"><?php echo $site_setting->currency_symbol.$task_info->task_price; ?></span> <span class="newyorkc">for Tasks of this type</span></h4><br/>
