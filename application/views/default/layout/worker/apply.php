...
function append_div2()
{
	...
	if(glry_cnt<5)
	{
		...
		var str = '<div onclick="remove_gallery_div('+num+')" class="fr" style="text-align:left;font-weight:bold;cursor:pointer;color:#ec6600;">Remove</div><div class="clear"></div>';			
...
$(document).ready(function(){
	...
	function validate_apply()
	{
		...
		?>
        <div class="red-subtitle top-red-subtitle">Tasker Application : <?php echo $this->session->userdata('full_name'); ?></div>
        ...
        <div class="">
                    ...
                    <li>
                    	<div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1">
                                ...
                                <tr>
                                    <td width="12%" style="float:left; padding-top:6px; color:#565656;"><h4>Cities : </h4></td>
                                ...
                                <div class="clear"></div>
                                <span id="req" style="color:red; text-align:left; margin-left:-11px;">*</span><span style="font-weight:normal; font-size:14px;">(You can select multiple cities by holding Ctrl key)</span>
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1">
                          ...
                          <tr>
                            ...
                            $post_worker_available_day=array();
                                    ...
                                    ?>
                                    <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <h4 style="float:left;" class="question">3. What days of the week are you generally available ? <span id="req" style="color:red;">*</span></h4><p id="worker_available_day_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_available_dayInfo" style="display:block;"></span>
                            <br />
            ...
            <div class="area-ph" style="text-align:center; margin-bottom:30px;"> 
                <input type="submit" name="worker_apply" class="btn btn-default btn-default-join btn-app" id="apply" value="Apply">   
            </div>
