...
function submitattachment_valid()
{
	...
	if(bgchk==true)
	{
		...
		<div class="page-title mbot20">
			<h1 class="mleft15">Runners Application: <a href="<?php echo base_url().'user/'.$user_info->profile_name; ?>" style="color:black"><?php echo $this->session->userdata('full_name'); ?></a></h1>
		</div>
            

			<ul class="appul">
            	<li>Welcome to the <?php echo $site_setting->site_name;?> Runner application process!</li>
            	<li>There are 4 simple steps to becoming an official Runner:
            	...
            	<li><p><b>Please note:</b> we often have a waiting list to become a Runner. When this is the case, it may take some time to move through this process. We very much appreciate your patience and are expanding as fast as our cottontails can manage!</p></li>
...
<table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1">
  ...
  <tr>
    <td><h4>State</h4><input name="worker_state" type="text" class="ntexttf" value="<?php echo $worker_state; ?>" id="worker_state" /></td>
  </tr>
  ...
  <tr>
    <td><h4>Home neighborhood</h4><input name="worker_home_neighborhood" type="text" class="ntexttf" value="<?php echo $worker_home_neighborhood; ?>" id="worker_home_neighborhood"/></td>
  </tr>
  ...
  <tr>
    <td>
        <h4>2. How do your talents, skills, and qualities contribute to your wanting to become a Runner?</h4>
  ...
  <tr>
    <td>
<h4>8. How did you hear about <?php echo $site_setting->site_name; ?>?</h4>
...
<ul class="apque">
	<li><label><input type="checkbox" name="worker_hear_about[]" value="Craigslist" id="worker_hear_about" <?php if(in_array('Craigslist',$post_worker_hear_about)){  echo 'checked="checked"';} ?>/>Craigslist</label></li>
	...
	<li><label><input type="checkbox" name="worker_hear_about[]" value="Email Marketing" id="worker_hear_about"  <?php if(in_array('Craigslist',$post_worker_hear_about)){  echo 'checked="checked"';} ?>/>Email Marketing</label></li>
	...
	<li><label><input type="checkbox" name="worker_hear_about[]" value="Magazine/Newspaper (WSJ, NYT, Wired)" id="worker_hear_about"  <?php if(in_array('Magazine/Newspaper (WSJ, NYT, Wired)',$post_worker_hear_about)){  echo 'checked="checked"';} ?>/>Magazine/Newspaper (WSJ, NYT, Wired)</label></li>
  ...
  <tr>
  	<td><h4>Birthdate</h4>
		...
		<li>
            ...
            <?php
                ...
                {
            ?>
            <option value="<?php echo $i; ?>"  <?php if($bobyear ==  $i){ echo 'checked="checked"';} ?> ><?php echo $i; ?></option>
            <?php
                }
            ?>
            </select>
            ...
            <option value="1" <?php if($bobmonth == '1'){ echo 'checked="checked"';} ?>>January</option>
            <option value="2" <?php if($bobmonth == '2'){ echo 'checked="checked"';} ?>>February</option>
            <option value="3" <?php if($bobmonth == '3'){ echo 'checked="checked"';} ?>>March</option>
            <option value="4" <?php if($bobmonth == '4'){ echo 'checked="checked"';} ?>>April</option>
            <option value="5" <?php if($bobmonth == '5'){ echo 'checked="checked"';} ?>>May</option>
            <option value="6" <?php if($bobmonth == '6'){ echo 'checked="checked"';} ?>>June</option>
            <option value="7" <?php if($bobmonth == '7'){ echo 'checked="checked"';} ?>>July</option>
            <option value="8" <?php if($bobmonth == '8'){ echo 'checked="checked"';} ?>>August</option>
            <option value="9" <?php if($bobmonth == '9'){ echo 'checked="checked"';} ?>>September</option>
            <option value="10" <?php if($bobmonth == '10'){ echo 'checked="checked"';} ?>>October</option>
            <option value="11" <?php if($bobmonth == '11'){ echo 'checked="checked"';} ?>>November</option>
            <option value="12" <?php if($bobmonth == '12'){ echo 'checked="checked"';} ?>>December</option>
            </select>
            ...
            <?php
                ...
                {
            ?>
            <option value="<?php echo $i; ?>" <?php if($bobday ==  $i){ echo 'checked="checked"';} ?>><?php echo $i; ?></option>
            <?php
                }
            ?>	
            </select>
     ...
     <input type="submit" name="worker_apply" class="submbg2" value="Apply">      
