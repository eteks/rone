...
<!--banner-->
<div class="red-subtitle top-red-subtitle">Browse Task By Location</div>
                         ...
                         ch:[
                                ...
                                {el:'div',att:{id:'leftPane1'},
                                    ...
                                    <?php if($task_activity_status==0) { ?>
                                            ...
                                            ch:[
                                                {txt:'Tasks of this type: '},{el:'span',att:{'class':'colora1'},ch:[{txt:'<?php echo mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').' - '.mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price;?>'}]}
                                                ]
                                            }
                                            ...
                                            ch:[
                                                {txt:'Tasks of this type: '},{el:'span',att:{'class':'colora1'},ch:[{txt:'<?php echo mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price.' - '.mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price;?>'}]}
                                                ]
                                            }
