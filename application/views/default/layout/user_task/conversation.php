...
document.frm_new_comment.comment.value="Okay , I am awarding you this task , lets start.";    
...
<div class="red-subtitle top-red-subtitle">Conversation</div>
    ...
    <div class="container">
        ...
        <div class=""> 
            <div class="dbleft dbleft-offer" style="padding:0px 0px 0 0px; width:100%; border:0; margin-left:0px; border-radius:10px; background:#fff;">
                <div class="left-part-1">
                    ...
                    <div class="top-name">
                        ...
                        <div class="top-date">Date : <?php echo date("d/m/Y H:i", strtotime($task_detail->task_post_date)); ?></div>
                    </div>
                    <div class="top-detai">
                                        ...
                                        <li class="posrel">
                                            ...
                                            <div class="taskdetails">
                                                <table width="100%" border="0" cellspacing="1" cellpadding="0">
                                                    <tr>
                                                        <td width="30%" class=""  style="padding-bottom:3px;">
                                                    ...
                                                    <tr>
                                                        <td width="40%" style="padding-bottom:5px;">
                                                            ...
                                                            <div class="fl fs14" style="color:#ec6600;"><?php echo $total_rate; ?>/5(<?php echo anchor('user/'.$row->profile_name.'/Omdömen',$total_review.' reviews','class="fpass" style="color:#ec6600;"');  ?>)</div>
                                                        </td>
                                ...
                                <ul class="padli10">
                                    ...
                                    {	
                                     ...
                                     <p><?php echo anchor('user/'.$check_worker_detail->profile_name,ucfirst($check_worker_detail->first_name).' '.ucfirst(substr($check_worker_detail->last_name,0,1)),' class="dhan" ');?> marked this task completed. </p>
                                        ...
                                        <?php } elseif($task_detail->task_activity_status!=3) { ?>
                                          ...
                                          <input type="hidden" id="task_user" name="task_user" class="chbg fl" value="<?php echo $task_user;?>">
                                            <div class="marT10" style="padding-left:0px; padding-bottom:0px;">
												<?php if($task_detail->task_activity_status!=2 && $task_detail->worker_agree!=1) {  ?>
                                                    <input type="submit" id="accept" name="accept" class="btn btn-default btn-category fr btn-category-2 marL5 btn-default-join-hiw" style="font-size:13px;" value="Send Message">
                                                <?php } ?>
                                               ...
                                               /*if(($task_detail->task_activity_status==1 || $task_detail->task_activity_status==2) || (($task_detail->worker_agree==0 || $task_detail->worker_agree==1) && $task_detail->task_activity_status==3) ) { ?>
                                                 ...
                                                 <input type="button" id="complete" name="complete" class="btn btn-default btn-category btn-category-2 fr marL5 btn-default-join-hiw" value="Complete Task" style="font-size:13px;" onclick="window.location.href='<?php echo site_url('user_task/complete/'.$task_id) ?>'">
                                          ...
                                          <input type="button" id="complete" name="complete" class="btn btn-default btn-category btn-category-2 fr marL5 btn-default-join-hiw" value="Dispute Task" style="font-size:13px;" onclick="disp();">
                    ...
                    <div class="detail-box">
                        ...
                        <div style="padding:0 10px 10px 10px;">
                            <div class="task-details-info">
                                <div class="task-details-info-left">Emaployer</div>
                            ...
                            <div class="task-details-info">
                                <div class="task-details-info-left">Tasker</div>
                            ...
                            <div class="task-details-info">
                                <div class="task-details-info-left">Posted date</div>
                                <div class="task-details-info-right"><?php echo date("d/m/Y H:i", strtotime($task_detail->task_post_date));?></div>
                            </div>
                            <div class="task-details-info">
                                <div class="task-details-info-left">Delivery Time</div>
                                <div class="task-details-info-right"><?php if($task_detail->task_end_day!="") { echo date("d/m/Y", strtotime($task_detail->task_end_day)); }?>&nbsp;<?php echo $task_detail->task_end_time;?></div>
                            </div>
                            <div class="task-details-info">
                                <div class="task-details-info-left">Offer Price</div>
                                <div class="task-details-info-right"><?php echo $site_setting->currency_symbol ?> <?php $offfer_amount = $this->user_task_model->offer_price($user_worker_id, $task_id);
                echo $offfer_amount->offer_amount;?></div>
                            ...
                            <div style="margin-top:15px;">
                                                   ...
                                                   if($task_user_id == get_authenticateUserID()) { ?>
                                                       <?php
													   if(($task_detail->task_activity_status==1 || $task_detail->task_activity_status==2) ) { 
													   
													   if($site_setting->transection_need==1)
                                                       {
                                                       if($assign_pay_status==1) {?>
														 <input type="button" id="complete" name="complete" class="btn btn-default btn-category btn-category-2 fr marL5 btn-default-join-hiw" value="Complete Task" style="font-size:13px;" onclick="window.location.href='<?php echo site_url('user_task/complete/'.$task_id) ?>'">
          ...
          <!--<input type="button" id="complete" name="complete" class="chbg fl marL5" value="Dispute Task" onclick="disp();">-->
              
              <?php }  ?>
                                                       <?php if($task_detail->task_activity_status==0) { ?>
                                                            <input type="button" id="accept" name="accept" class="btn btn-default btn-category btn-category-2 btn-default-join-hiw" value="Award Task" onclick="accept_offer();">
                                                        <?php } 
                                                   }
                                                   ?>
                                                   </div>
