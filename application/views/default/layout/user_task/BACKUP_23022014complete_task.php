<div>
	...
	<div class="page-title mbot20">
		<h1 class="mleft15">Complete Tasks</h1>
	</div>
...
function dispute(ID) {
	...
	if(ID == 2){ 
    	...
    	<li>
        	<b class="fl marR5">Runner&acute;s Rate:</b>
    	...
    	<li>
        	...
        	<input type="submit" id="sub_task" name="sub_task" class="chbg fr marT5" value="Submit & Closed">
            <div class="clear"></div>
