...
<div>
	...
	<!--<div class="page-title mbot20">
		<h1 class="mleft15">Closed Tasks</h1>
	</div>-->
                    ...
                    <div class="mconright dbright-task-main-posted">
                        <div class="" style="text-align:center;">
                            ...
                            <div class="fleft100">
                                ...
                                <?php echo anchor('user_task/closed_tasks','Closed','class="b-button b-button-2 selected-task" style="text-align:center; padding-left:0px;"');?>
                            </div>
                        </div>
                    </div>
                </div>
