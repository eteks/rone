...
<div>
	<div>
     ...
     <div class="red-subtitle top-red-subtitle" style="margin:0px 0 0 0">Complete Jobs</div>
        ...
        <li style="padding-bottom:10px;">
                ...
                <tr>
                	<td valign="middle" width="100">
                        ...
                        ?>
                        <b style="padding-right:3px;" class="fs14">Assigned To : </b>
                    </td>
                ...
                <tr>
                	<td style="padding-top:5px;"><b class="fs14">Assigned to : </b></td>
                ...
                <tr>
                	<td style="padding-top:5px;"><b class="fs14">Complete : </b> </td>
	...
	if(ID == 2){ 
    	...
    	<li>
         <!--<div id="dialog-form-dispute" style="padding-bottom:5px;">
        	...
        	<b class="fl marR5 fs14" style="width:100px;">Rate Helper :  </b>
    	...
    	<li>
           ...
           <!--	<input type="submit" id="sub_task" name="sub_task" class="chbg fl marT5" value="Submit">-->
        	<input type="submit" id="sub_task" name="sub_task" class="btn btn-default" value="Submit & Closed" style="margin-left: 100px;">
          </span>
            <div class="clear"></div>
