...
<div>
    ...
    <div class="red-subtitle top-red-subtitle" >Draft Tasks</div>
                    ...
                    <div class="mconright dbright-task-main-posted">
                        <div class="" style="text-align:center;">
                            ...
                            <div class="fleft100">
                                ...
                                <?php echo anchor('user_task/draft_tasks','Draft','class="b-button b-button-2 selected-task" style="text-align:center; padding-left:0px;"');?>
        ...
        <div class="clear"></div>
            ...
            <ul class="ulsty">
              ...
              echo ucfirst($row->task_name);
                        ...
                        <div class="catle3n2">
                          <div class="urgent-price urgent-price-2" style="margin-bottom:10px; background:#82ac02; border:0px; color:#fff;">
                            <?php echo anchor('task/pay/'.$row->task_id,'Post Task','style="color:#fff;"');?>
                            <div class="clear"></div>
                          </div>
