...
<div>
	...
	<!--<div class="page-title mbot20">
		...
		<h1 class="mleft15">My Posted tasks</h1>
	</div>-->
    <div class="red-subtitle top-red-subtitle">My posted tasks</div>
                ...
                <div class="dbleft dbleft-main posted-task-right fr">
                  ...
                  <p class="marB5"><b>Amount Paid : </b><span class="fpass fs14 colora"> <?php echo $site_setting->currency_symbol.$assign_time_pay_amount; ?></span></p>
                    ...
                    <?php } elseif($is_assign == 1 && $assign_pay_status==0 && $assign_time_pay_amount==0) { ?>
                     ...
                     <!-- <p class="marB5"><span class="fpass fs14 colora"> <?php echo anchor('wallet/add_wallet','Make payment from here for amount '.$site_setting->currency_symbol.$payable_amount,'class="fpass colora"'); ?></span></p>.-->
