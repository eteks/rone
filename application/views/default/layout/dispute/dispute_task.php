...
<div>
 ...
 <div class="red-subtitle top-red-subtitle">Dispute Conversation</div>
...
<!--<div id="s1postJ" class="padB10"><b>Dispute Conversation with: <?php 

if(get_authenticateUserID()==$worker_detail->user_id)
{
echo anchor('user/'.$user_detail->profile_name,$user_detail->first_name.' '.substr($user_detail->last_name,0,1),' style="color:black;" ');
}

if(get_authenticateUserID()==$user_detail->user_id)
{
echo anchor('user/'.$worker_detail->profile_name,$worker_detail->first_name.' '.substr($worker_detail->last_name,0,1),' style="color:black;" ');
}
...
<ul class="padli10">
				<li style="padding-bottom:15px; border-bottom:1px dotted #565656;">
                    <div class="addtl"  style="width:72px;float:left;"><img src="<?php echo base_url().getThemeName();?>/images/per.jpg" width="50" height="50" alt="" /></div>
                    <div class="addtr" >
                        <h2 class="col"><?php echo ucfirst($task_detail->task_name);?></h2>
                        <div style="float: left;">posted in <?php echo ucfirst($task_detail->city_name); ?></div>
                    </div>
                    <div class="clear"></div>
                </li>
               ...
               <!-- </li>-->
                ...
                <li>
                	<div class="inside-subtitle" style="width:112px;">Description:</div>
                    <p class="LH18 fl" style="clear:both;">
                        <?php 
               ...
               <!-- <li>
                ...
                <?php } ?>
                   ...
                   <!-- <li>The Worker bee will need to spend to: <b><?php echo $site_setting->currency_symbol.number_format($task_detail->extra_cost+$task_detail->other_cost,2); ?></b></li>
...
<div class="marTB20 inside-subtitle" style="width:210px; clear:both;">Dispute Conversations</div>     
<ul class="padli10 marT10" style="clear:both;">
	<?php $total_comment = 0;
	if(!empty($result)){
	...
	?>
        <li class="posrel" style="border-bottom:1px dotted #565656;">
            <div rel="tooltip2" class="tpp" title="<?php echo $user_detail->full_name.'('.date($site_setting->date_time_format,strtotime($row->dispute_comment_date)).')';?>">
			  ...
			  ?>
                <div class="<?php echo $conbg;?> marL10 fl detail_left">
...
?>  
    <ul class="padli10">
    	<li>
            ...
            <div class="conbg3 marL10 fl">
              <textarea name="comment" cols="63" rows="5" class="text_box_size detail_left"></textarea> 
              ...
              <input type="hidden" id="dispute_id" name="dispute_id" class="chbg fl" value="<?php echo $dispute_id;?>">
                <div class="marT10">
                    ...
                    <input type="submit" id="dispute" name="dispute" class="btn btn-default fr" value="Send">
                    <div class="clear"></div>
                </div>
            </div>
            <div class="clear"></div>
...
?>  
    <ul class="padli10">
    	<li>
            ...
            <div class="conbg3 marL10 fl detail_left">
              <textarea name="comment" cols="63" rows="5" class="text_box_size detail_left"></textarea> 
              ...
              <input type="hidden" id="dispute_id" name="dispute_id" class="chbg fl" value="<?php echo $dispute_id;?>">
                <div class="marT10">
                    ...
                    <input type="submit" id="dispute" name="dispute" class="btn btn-default" value="Send">
                    <div class="clear"></div>
                </div>
            </div>
            <div class="clear"></div>
...
<?php }
 ...
 <div class="dbright-task dbright-task-main">
  <?php echo $this->load->view($theme.'/layout/user/user_sidebar',$data); ?>
  </div>
   <div class="clear"></div>     
</div>
<div class="clear"></div>     
