...
<?php } if($error=='update') {  ?>
	...
	<div class="follfi">Credit Card Information Added Successfully.</div>
      ...
      <?php } ?>
           ...
           <div id="s1post">Set up your credit card</div>
...
<div class="tabs2">
            ...
            <h3 class="crec fs14">Credit card <span id="req" class="crec1" >We store your credit card to make posting Tasks easier. <a href="#learnmoreinfo" id="learnmore">Learn more</a></span> </h3>
