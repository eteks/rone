...
<div>
	...
	<!--<div class="page-title mbot20">
		<h1 class="mleft15">Min digitala plånbok(<?php echo $site_setting->currency_symbol.$total_wallet_amount;	?>)</h1>
	</div>-->
    <div class="red-subtitle top-red-subtitle">Historik - Saldo  (<?php echo $site_setting->currency_symbol.$total_wallet_amount;	?>)</div>
    	<!--<div class="mconleft">-->
...
<table width="100%" border="0" cellspacing="1" cellpadding="0">
  <tr>
    ...
    <td align="right" class="mar_bot">
		<?php echo anchor('wallet/add_wallet','Sätt in','class="btn btn-default"'); ?> 
...
<table width="100%" cellspacing="0" cellpadding="0" border="0" align="left" id="wallet_table">
             ...
             <tr>
                ...
                <th>Uppdrag</th>
                <th style="text-align:center;">Transaktion</th>
...
<tr class="<?php echo $cls; ?> <?php if($i % 2 == 0){ echo " odd "; } else { echo " even "; }; ?>">
			...
			<tr class="even">
			<td colspan="8" align="center" valign="middle"><?php echo "Du har ingen transaktionshistorik eftersom att du inte har slutfört något uppdrag."; ?>.</td>
			</tr>
