               ...
               <li>
                    ...
                    <?php 
                        ...
                        $status = '';
							...
							$status = '<p>Status på uppdrag: <span class="colora"><b>';
                       		 if($is_assign == 1){
                            	if(!empty($dispute)) {
	...
	<?php if($assign_pay_status==1 && $assign_time_pay_amount>0 && $is_assign == 1) { ?>
          ...
          <p class="marB5"><b>Amount Paid : </b><span class="fpass fs14 colora"> <?php echo $site_setting->currency_symbol.$assign_time_pay_amount; ?></span></p>
            ...
            <?php } elseif($is_assign == 1 && $assign_pay_status==0 && $assign_time_pay_amount==0) { ?>
              ...
              <p class="marB5"><span class="fpass fs14 colora"> <?php echo anchor('user_task/pay_now/'.$row->task_id,'Klicka här för att lägga till saldo '.$site_setting->currency_symbol.$payable_amount,'class="fpass colora"'); ?></span></p>.
            ...
            <?php } ?>
                                ...
                                ?>
                                    <p><b>Entoworker: </b> <?php echo anchor('user/'.$asssign_user->profile_name,$asssign_user->first_name.' '.substr($asssign_user->last_name,0,1),'class="fpass"'); ?></p>
                                <?php }
                                ...
                                <?php }  }
                                    ...
                                    if($is_assign == 3) {
                                ?>
                                    <p><b>Stängd: </b> <span class="geo geo-2"><?php echo date($site_setting->date_time_format,strtotime($row->task_close_date)); ?></span></p>
                                <?php } ?>
                                </li>
                                <div class="clear"></div>
