	...
	<div class="page-title mbot20">
    	...
    	<div class="mconleft" style="margin:0 0 0 15px;">
            ...
            <div class="padB20">
                    ...
                    <ul class="ulleftmt">
                    <li>
                   <?php echo anchor('user_task/mytasks','Mine','  class="fpass fs14 act"');?>
                   </li>
                    <li>
                   <?php echo anchor('user_task/all_tasks','Alla','  class="fpass fs14"');?>
                   </li>
                    <li>
                   <?php echo anchor('user_task/open_tasks','Öppna',' class="fpass fs14"');?>
                   </li>
                    <li>
                   <?php echo anchor('user_task/assigned_task','Tilldelade','class="fpass fs14"');?>
                   </li>
                    <li>
                   <?php echo anchor('user_task/closed_tasks','Stängda',' class="fpass fs14"');?>
                   </li>
                    <li>
          ...
          <p class="marB5"><b>Amount Paid : </b><span class="fpass fs14 colora"> <?php echo $site_setting->currency_symbol.$assign_time_pay_amount; ?></span></p>
        	...
        	<div class="fl wid100 marL80">
					 ...
					 { 
						...
						if(($is_assign == 1) || ($is_assign == 2) || ($is_assign == 3)) {		
						 ...
						 echo anchor('user_task/conversation/'.$row->task_worker_id.'/'.$row->task_id,'Conversation',' class="chbg"');
							...
							if($offercount != 0) {
								echo anchor('user_task/worker_offer/'.$row->task_id.'/0',$offercount.' Offer',' class="chbg"');
							}
						}
                ...
                ?>
							...
							if(!empty($dispute)) {
							 	echo anchor('dispute/dispute_task/'.$row->task_id,'Dispute','class="chbg"');
							}
						?>              
                            </div>
                        </div>
