...
function deletechecked()
{
	...
	<?php  if($task_detail->user_id == get_authenticateUserID()) { ?>
        <div class="inside-subtitle inside-subtitle-2">Task Actions</div>
        <div class="fleft100">
        	
            <?php if($task_detail->task_activity_status==0) { ?>
        
            <a href="javascript:void()" onclick="return deletechecked();" class="b-button b-button-2">Cancel Task</a>
           ...
           <?php  $chk_bid=0;
                       ...
                       <?php echo anchor('task/edit_task/'.$task_detail->task_id,'Edit Task','class="b-button b-button-2"'); ?>
...
<div class="inside-subtitle inside-subtitle-2">Share with Friends</div>
