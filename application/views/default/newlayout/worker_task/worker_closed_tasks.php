...
<div>
	<div>
    	...
    	<div class="red-subtitle top-red-subtitle">Stängda uppdrag</div>
...
<ul class="ulnobor">
            ...
            <p>Status på uppdrag: <span class="colora"><b>Closed</b></span></p>
	             <?php  
		...
		<div class="marTB5">
        	<div class="fl wid100 marL80">
             ...
             <div class="fr" >
    	        ...
    	        <?php echo anchor('worker_task/conversation/'.$row->worker_id.'/'.$row->task_id,'Konversation',' class="btn btn-default"');?>
