...
<div>
	<div>
    <div class="red-subtitle top-red-subtitle">Omdömen <?php echo anchor('user/'.$user_profile->profile_name,ucfirst($user_profile->first_name).' '.ucfirst($user_profile->last_name),'style="color:black"');?></div>
                      ...
                      <?php if($result) { 
                    	...
                    	<li>
                            ...
                            <div class="taskdetails">
                            	<div class="abmarks-2 abmarks-2-2">Betyg för <?php echo anchor('tasks/'.$review->task_url_name,ucfirst($review->task_name),' class="unl"'); ?></div>
                              
                                <div class="strmn strmn-2"><div class="str_sel str_sel-2 fl" style="width:<?php if($review->comment_rate>5) { ?>100<?php } else { echo $review->comment_rate*2;?>0<?php } ?>%;"></div></div>
