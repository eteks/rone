                        ...
                        <div class="details-title-info details-title-info-all">
                            ...
                            <div class="starmenu marB10 fl" >
                                ...
                                ?>
                                    ...
                                    <div class="rate rate-info fl" style="clear: both; margin:5px auto 0; overflow: hidden; text-align:center;"><p class="normal-text"><?php echo $total_rate; ?>/5  ( <span><?php echo anchor('user/'.$user_profile->profile_name.'/reviews',$total_review.' Omdömen');  ?> </span> )</p></div>
                                    <div class="clear"></div>
                                </div> 
                            <!--<div class="roboimg icon-profile">
                                ...
                                <a href="#" class="link3 tooltip">
                                    ...
                                    <span>Personlig verifikation</span>
                                </a>
                                <?php } ?>
                                <div class="clear"></div>
                            </div>-->
        ...
        echo "<br /><br />";
                    ...
                    foreach($activities as $res)
                    {
                        ...
                        switch ($act)
                        {
                                case 'signup':
                                  ...
                                  ?>
                                    ...
                                    if(isset($custom_msg)) { if($custom_msg!='') { ?>
                                     ...
                                     <br><a id="twoonebr1" class="tooltip tooltip-2">Level <?php echo $custom_msg; ?><span>Level <?php echo $custom_msg;?> Entoworker</span></a>
                                    ...
                                    <div class="taskdetails">
                                        ...
                                        <div class="colmark colmark-2">Välkommen!</div>
                                ...
                                <?php  
                                  ...
                                  ?>
                                   ...
                                   <div class="taskphoto taskphoto-2">
                                    ...
                                    <div class="taskdetails">
                                        <?php echo anchor('user/'.$profile_user_url_name,$profile_user_name,'class="abmarks abmarks-2 unl"'); ?>
                                        <div class="colmark colmark-2">har skrivit upp sig som Entoworker!</div>
                                        <div class="geo geo-2"><?php echo $activity_date; ?></div>
                                    </div>
                                ...
                                case 'posttask':
                                 ...
                                 <li class="posrel">
                                    ...
                                    <div class="taskdetails">
                                        ...
                                        <div class="colmark colmark-2">Skapad av <?php echo anchor('user/'.$profile_user_url_name,$profile_user_name,'class="colgreen"'); 
                                ...
                                <li class="posrel">
                                    ...
                                    <div class="taskdetails">
                                        <?php echo anchor('user/'.$profile_user_url_name,$profile_user_name,' class="abmarks abmarks-2 unl"'); ?>
                                        <div class="colmark colmark-2">Accepterade budet från <?php 
                                ...
                                <li class="posrel">
                                    ...
                                    <div class="taskdetails">
                                        ...
                                        <div class="colmark colmark-2">har markerats som klar av <?php 
                            ...
                            <?php
                                ...
                                <li class="posrel">
                                    ...
                                    <div class="taskdetails">
                                        <?php echo anchor('tasks/'.$activity_url_name,ucfirst($activity_name),' class="abmarks abmarks-2 unl"'); ?>
                                        <div class="colmark colmark-2">har utförts av <?php 
                                        if(isset($custom_msg)) { if($custom_msg!='') {
                       ...
                       <!-- <a href="javascript:void();" class="cm chbg"><b>Use Template</b></a>-->
                        ...
                        <div><span class="newrep">Nytt svar om</span> <?php echo anchor('tasks/'.$activity_url_name,ucfirst($activity_name),' class="unl abmarks abmarks-2"');?></div>
                        <?php } ?>
            ...
            <?php }
                                    ...
                                    <div style="text-align:center;">
                                                <?php echo anchor('user/'.$user_profile->profile_name.'/activities/','Se mer',' class="btn btn-default btn-seemore"');?>
                                    </div>
                                </div>
                                ...
                                <li class="posrel">
                                    ...
                                    <div class="taskdetails">
                                        <div class="abmarks-2">Betyg för <?php echo anchor('tasks/'.$review->task_url_name,ucfirst($review->task_name),' class="unl"'); ?></div>
                                        ...
                                        <div class="strmn strmn-2 fl"><div class="str_sel str_sel-2 fl" style="width:<?php if($review->comment_rate>5) { ?>100<?php } else { echo $review->comment_rate*2;?>0<?php } ?>%;"></div></div>
                                            <div class="strig">
                                             ...
                                             <div class="geo geo-2">för <?php echo getDuration($review->comment_date); ?></div>
                                        </div>    
                             ...
                             <li>Du har inga omdömen eftersom att du inte har något avslutat uppdrag.  </li>
                             
                             <?php } ?>
                                    </ul>
                                    <div style="text-align:center;"><?php echo anchor('user/'.$user_profile->profile_name.'/reviews/','Se mer',' class="btn btn-default btn-seemore"');?></div>
                                    <div class="clear"></div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="top-skill">
                        	...
                        	<div class="top-skill-title">Mina Kompetenser</div>
                            <div class="skill-btn">
                            <?php
                            ...
                            <div style="text-align:center; margin:15px 0px;">
                            	<?php echo anchor('worker/edit/','Redigera Kompetenser',' class="btn btn-default btn-seemore"');?>
                            </div>
                        </div>
                        <?php } ?>
                        <div class="clear"></div>
