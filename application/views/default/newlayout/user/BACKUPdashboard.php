				...
				$user_image=base_url().'upload/user/'.$ttask->profile_image;
                        ...
                        <li>
                            ...
                            <div class="dimright">
                             ...
                             <?php echo anchor('task/update_task_step_zero/'.$ttask->task_id.'/copy','<b>Use Template</b>',' id="copytask_'.$ttask->task_id.'" class="cm temp" ');?>
...
<?php } ?>
 ...
 <div class="geo">about <?php echo getDuration($task_post_date); ?></div>
                              ...
                              <?php echo anchor('task/update_task_step_zero/'.$ntask->task_id.'/copy','<b>Use Template</b>',' id="copynewtask_'.$ntask->task_id.'" class="cm temp" ');?>
