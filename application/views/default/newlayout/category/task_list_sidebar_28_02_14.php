<div id="needhelp-ph">
<p class="needhelp">Need help with <?php  echo $category_infos->category_name;?>?</p>
</div>
<div id="right-panel-bg">
<div class="posttask-ph">
 <?php if(!check_user_authentication()) {  echo anchor('sign_up','Post a Task',' class="login_new" ');  } else {       
        
        echo anchor('new_task','Post a Task',' id="various3" class="login_new" '); } ?> 
</div>      
         ...
         <div class="runnerph">
         <h3 class="runner" style="margin:0 0 15px 37px">View runner in boston </h3>
  ...
  <?php } ?>      
        <!----map--->
         ...
         <ul class="rightbottom-links">
           ...
           <li><?php echo anchor('how_it_works','How it works'); ?></li>
           <li>	<?php echo anchor('who-are-the-taskers','Become a Runners');?></li>
