                ...
                <div class="wow fadeIn animated  animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
                    <div class="border-black-main" style="margin-bottom:50px;">
                        <div class="border-black-left-main">
                            ...
                            <!--<div class="category_btn-main"> <?php echo anchor('tags/',"Gå tillbaka","class='btn btn-default btn-category'"); ?></div>-->
                        </div>
                        <div class="border-black-right-main">  
                            <div class="category_name">Aktiva uppdrag inom: <?php  echo $category_infos->category_name;?></div>    
                            <div class="inner-category-info inner-category-info-pro" id="inner-category-info_1">
                                ...
                                <div class="clear"></div>
                                            ...
                                            <?php } } else {?>
                                                <li style="padding-left:15px; text-align:center;" ><strong>Det finns tyvärr inga aktiva uppdrag inom denna kategori</strong></li>
                                            <?php } ?>
                                            </ul>                        
                        	</div>
