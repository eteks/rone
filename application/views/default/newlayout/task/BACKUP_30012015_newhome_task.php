...
<div>
<div>
<div class="red-subtitle" style="margin:162px 0 0 0">Post New Task</div>
...
<?php $cities=city_list(); ?>
    ...
    <span><strong>Please Select a location</strong>:</span>
        <select name="task_city_id" id="task_city_id" class="selboxwi200" title="Please select a location" style="width:40%; padding:8px; background:#fff; color:#000; font-size:14px; margin:0; height:45px; border:#666 1px solid">
			<?php 
				if($cities){
					foreach($cities as $c){
			?>
...
<input name="task_category_id" id="task_category_id" type="hidden" value="" />
  ...
  <div style="padding-left:130px;"> 
    ...
    <div id="container-cat-fancy" style="width: 940px;">
	<span><strong>Please Select a Task Category</strong></span>  
	<span></span>  
    <div id="carousel-cat-fancy" style="margin-top:10px;">
    ...
    <a style="cursor:pointer" id="ui-carousel-next-cat-fancy" class="mid"><span>next</span></a>
    <a style="cursor:pointer" id="ui-carousel-prev-cat-fancy" class="mid"><span>prev</span></a>
</div>
...
<td width="30%" align="left"><h2 class="colblack marL10 taskname">Category Selected</h2></td>
<td width="70%"><img src="" width="60" height="60" alt="" border="0" id="selcatimg" /><br /><span id="results"></span></td>
	...
	<div class="underl posrel" style="display:none;">
...
<div class="area-ph fleft100 mbot15" style="padding-top:75px;">
                <input name="sub_step" class="submbg2 chbg" value="Save &amp; Continue" type="submit">    
