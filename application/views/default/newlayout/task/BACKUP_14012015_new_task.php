...
<link type="text/css" rel="stylesheet" href="<?php echo base_url().getThemeName(); ?>/js/css/category-slider-fancy-newtask_new.css"/>
...
<label><strong>Post New Task</strong>:</label>
...
<?php $cities=city_list(); ?>
    ...
    <span id="s2post">Please Select a location</span>
        <select name="task_city_id" id="task_city_id" class="normalTip selboxwi200" title="Please select a location" style="width:20%; padding:8px; background:#fff; color:#000; font-size:14px; margin:0; height:45px; border:#666 1px solid">
			<?php 
				if($cities){
					foreach($cities as $c){
			?>
...
<input name="task_category_id" id="task_category_id" type="hidden" value="" />
    ...
    <div id="container-cat-fancy" style="margin-left: 210px;">
...
<div class="underl marT10" style="margin-left: 210px;">
...
<td width="30%" align="left"><h2 class="colblack marL10 taskname" style="font-size:20px;">Category Selected</h2> : </td>
