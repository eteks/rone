  ...
  ?></p>
     ...
     <?php   if($task_detail->task_activity_status==0) {
        ...
        <div id="right-panel-bg">
           ...
           <!-- <div id="needhelp-ph">
			<p class="needhelp">Jag vill också få hjälp med detta!</p>
			</div>-->
		    ...
		    ?>
                 <div class="pricing_pro">
                 	<p style="font-size: 14px;margin: 5px auto;">Notera: Du måste ansöka om medlemskap innan du kan lägga bud på uppdrag!</p>
                     <?php   echo anchor('who-are-the-taskers','Lägg bud på uppdrag!','class="b-button b-button-2 b-button-2-2" style="border-top:1px solid #d6d6d6;"'); ?>
			...
			<div class="pricing_pro">
            	<p style="font-size: 14px;margin: 5px auto;">Notera: Du måste ansöka om medlemskap innan du kan lägga bud på uppdrag!</p>
                     <?php   echo anchor('login','Lägg bud på uppdraget!','class="b-button b-button-2 b-button-2-2" style="border-top:1px solid #d6d6d6;"'); ?>
                 <div class="fleft100"></div>
                 </div>
			<?php } ?>
             <?php 
             if(!check_user_authentication()) 
             {  
             	echo anchor('sign_up','Skapa liknande uppdrag ',' class="b-button b-button-2" ');  
             }  
             else 
             { 
             	if($site_setting->subscription_need==0)
             	{
             	echo anchor('task/update_task_step_zero/'.$task_detail->task_id.'/copy','SKAPA LIKNANDE UPPDRAG ',' id="copytask" class="b-button b-button-2" '); 
			...
			<?php 
					...
					{
			?>
            				<a href="javascript:void(0)" class="b-button b-button-2 pupload13"><b>SKAPA LIKNANDE UPPDRAG</b></a>    
			<?php		
					}
...
<br />
            ...
            <div class="marB20">
                <div class="inside-subtitle inside-subtitle-2">Status på uppdrag</div>
            	...
            	<ul class="stcinn stcinn-1">
                	<li style=" margin:5px 0px; background-color:#<?php if($task_detail->task_activity_status==0) { ?><?php } else { ?><?php } ?>;float:left;">
                        ...
                        <tr>
                        <td width="80" class="posted"><b class="marL5">Skapad</b></td>
                ...
                <li style="margin:5px 0px; background-color:#<?php if($task_detail->task_activity_status==1) { ?><?php } else { ?><?php } ?>;float:left;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        <td width="80" class="posted"><b class="marL5">Tilldelad</b></td>
				 ...
				 if($worker_info->profile_image!='') {  
					...
					?>
                     <div class="posrel marTB10" style="clear:both; margin-left:15px; margin-right:15px;">
                       ...
                       <div class="ponright" style="float:left; text-align:left; margin-left:10px;">
                            ...
                            <p class="marTB3 fs13">Vald av <?php echo anchor('user/'.$task_user_detail->profile_name,ucfirst($task_user_detail->first_name).' '.ucfirst(substr($task_user_detail->last_name,0,1)).'.',' class="fpass" ');?></p>
                       </div>
                       <div class="clear"></div>
                    </div>
                    <?php } 
                	...
                	<li  style=" margin:5px 0px; background-color:#<?php if($task_detail->task_activity_status==2) { ?><?php } else { ?><?php } ?>;float:left;">
                        ...
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        <td width="80" class="posted"><b class="marL5">Utförd</b></td>
                        <td width="150" class="posted"><?php
				 ...
				 if($worker_info->profile_image!='') {  
                	...
                	<li style="margin:5px 0px; background-color:#<?php if($task_detail->task_activity_status==3) { ?><?php } else { ?><?php } ?>;float:left;">
						...
						<table width="100%" border="0" cellspacing="0" cellpadding="0">
                        <tr>
                        <td width="80" class="posted"><b class="marL5">Stängd</b></td>
                        <td width="150" class="posted"><?php
            ...
            <div class="marB20">
                <div class="inside-subtitle inside-subtitle-2">Övrigt</div>
                <ul class="accr">
                 <?php 
		   ...
		   if($task_detail->task_is_private==0 || $task_detail->user_id==get_authenticateUserID() || $task_detail->task_worker_id==$login_worker_id) {  
						...
						echo '<li class="copy-btn">'.anchor('tasks/'.$task_detail->task_url_name.'/comments','Se konversationer','class="b-button b-button-2"').'</li>'; 
                    ...
                    <?php /*?> <li><?php echo anchor('tasks/'.$task_detail->task_url_name.'/see_activity','See history'); ?></li><?php */?>
                      ...
                      <?php  $chk_bid=0;
                       ...
                       <li class="copy-btn"><?php echo anchor('task/edit_task/'.$task_detail->task_id,'Redigera uppdrag','class="b-button b-button-2"'); ?></li>
                    ...
                    <li class="copy-btn">
                      <?php   echo anchor('additional_information/information/'.$task_detail->task_id,'Övrig information','class="b-button b-button-2"'); ?>
                      </li>
                        <?php } ?>
                       ...
                       <li class="copy-btn"> 
					       ...
					       <?php if(!check_user_authentication()) 
						   {  echo anchor('sign_up','Kopiera uppdrag','class="b-button b-button-2"');  }  else { echo anchor('task/update_task_step_zero/'.$task_detail->task_id.'/copy','Kopiera uppdrag',' id="copytask1" class="b-button b-button-2"'); ?>
...
function infoWindowClose(sidebarLink){
	this.isInfoWindowOpen = false;
        ...
        <!----map--->
            ...
            <div class="marB20">
                <div class="inside-subtitle inside-subtitle-2" style="margin-bottom:20px;">Dela Uppdrag</div>
