...
<div>
 ...
 <div id="two-columnar-section" class="top-cont-main-dash">
        ...
        <div class="container">
        <div class="red-subtitle"><div class="count-number-1">3</div>Sammanfattning</div>
            ...
            <div class="tabs1">
            	<div class="left-part">
                    ...
                    <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                        ...
                        <div class="" >
                            ...
                            <p style="float:left; clear:both; ">i <?php echo ucfirst($task_detail->city_name); ?></p>
                        </div>
                        <div class="clear"></div>  
                    </div>                
                	<div class="margin-between"></div>
              		<div class="inside-subtitle" style="margin-bottom:10px;">Detaljer om uppdraget </div>    
                    <!--<div class="marL15" >
                    	<div id="icard"><b>
                    ...
                    <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                        <div class="marTB5">
                            <h4 class="main-title main-title-2">Beskrivning: </h4>
                            <div class="clear"></div>
                    ...
                    <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                        <div class="marTB5">
                                ...
                                <h4 class="main-title main-title-2">Plats: </h4>
                                <div class="clear"></div>
                            ...
                            </b><br/>--> Uppdraget ska vara utfört senast: <b>
                ...
                <div class="right-part">
                	<div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;" data-wow-delay="0.5s" class="span3 wow fadeInRight animated dbright-task-1 dbright-task-13 dbright-task-132">          
                        ...
                        <div class="clear step-pay-btn" style="float:right; margin-top:171px;">
                            <div class="fl"><?php echo anchor('task/step_one/'.$task_id,'Redigera', 'class="btn btn-default btn-post-btn edit-color" style="margin-top:0px !important;"');?></div>
                            <input type="submit" value="Slutför" class="btn btn-default btn-post-btn" name="sub_step2" style="margin-top:0px !important; ">
                        </div>
                    </div>
                </div>
                <div class="clear"></div>
