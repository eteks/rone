...
<?php } ?>
       ...
       <?php } } else { ?>
		<li> Sorry , There is no suited Tasker based on posted job criteria.You can still search and invite Taskers manually  from our Tasker list <?php echo anchor('task/alltasker/'.$task_id,'All Tasker',' class="unl abmarks"');?></li>
       <?php } ?>             
