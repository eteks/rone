...
<div class="main_new_task" style="width:700px;">
...
<?php $cities=city_list(); ?>
    ...
    <div style="text-align:center;">
	    <span id="s2post">Post a Job in</span>
    </div>
    <div style="text-align:center;">
        <select name="task_state_id" id="task_state_id" class="selboxwi200" style="margin-top: 17px;" onchange="get_city(this.value)">
    ...
    ?>
        ...
        <select name="task_city_id" id="task_city_id" class="selboxwi200" style="margin-top: 17px;">
...
<td width="20%" class="selsect_cate" align="left"><b class="colblack marL10" style="color:#d83a37;">Category Selected</b> : </td>
<td width="70%" class="select_resutl"><img src="" width="60" height="60" alt="" border="0" id="selcatimg" /><br /><span id="results"></span></td>
</tr>
</table>
...
<div class="padTB10 submit-btn-in" style="padding-left:160px;">
