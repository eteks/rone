...
<h1 class="mleft15">Post A Task</h1>
</div>
<?php
...
<div class="fleftfw" style="text-align:center"><img src="<?php echo base_url().getThemeName(); ?>/images/posttask-status1.png" /></div>        
           <div id="s1post" style="margin:0 0 0 15px">Post a Task</div>
...
<div class="tabs1">
          <div class="under">
            ...
            <div class="fl" style="margin:0 0 0 15px;"><label>Task Description</label>  <span id="req">This description is <b>public.</b></span><span > <a href="javascript:void(0);" id="addpnote" class="fpass">Add private notes</a></span></div>
            <a href="javascript:void(0);" id="prino"  class="fl marL5"><div class="questions"></div></a>
            <div class="clear"></div>
            <textarea name="task_description" class="ntext m15" id="task_description" cols="73" rows="5"><?php echo $task_description;?></textarea>
...
<div id="dialog-form-sprino">
			...
			<div class="under">
            	...
            	<div class="implcr wid550" style="float:left;width: 97%;">
                
                	<h3 class="section-title">Full addresses shared only with the assigned Runner</h3>
	 ...
	 <script type="text/javascript">
      ...
      google.maps.event.addDomListener(window, 'load', initialize);
                ...
                <div class="inner_content_two">
                    <ul id="add_more2">
                        <li id="more2" >
                            <div class="addleft LH30" style="float:left;width:300px;">
