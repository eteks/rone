<div class="mconright mconright-1">
<?php $site_setting=site_setting(); ?>
<div id="needhelp-ph">
	<div class="inside-subtitle inside-subtitle-12">När ska uppdraget utföras? </div>
    <div class="border-bot"></div>
</div>
<div id="right-panel-bg">
            	
        <!--<div class="LH18" style="padding-top:10px">
        
        	 	<div class="soleft" style="padding-left:5px;width:50px;"><img src="<?php// echo $category_image; ?>" alt="" width="48" height="40" /></div>
            
            <div class="soright" style="width:194px">
            ...
            <div style="padding-left:5px;padding-top:5px;"><b>Assignment: </b> <a href="<?php// echo base_url().'task/update_task_step_zero/'.$task_id;?>" id="various3" class="fpass">
           ...
           Let me review  </a> the Worker bee
            ...
            <?php// } ?>
       	  ...
       	  <span class="int" style="padding-left:5px;padding-top:5px;" >For Worker bee in <br/><?php //echo ucfirst($task_detail->city_name); ?></span>
          <a href="<?php //echo base_url().'task/update_task_step_zero/'.$task_id;?>" id="various4" class="fr chbg1 LH13">Change</a>
          <div class="clear"></div>
		...
		{	
			...
			$post_date= $dateTime->format("dd-mm-YYYY H:i:s");
			
		}
		
		
		?>
		<div class="estim" style="color:#585858; float:left; width:100%; text-align:left; margin:0px 0 10px 0;font-size:20px;">Slutdatum:</div>
                    ...
                    <li id="sline" class="LH20" style="display:block; clear:both; padding:0px; margin-bottom:20px;" >
                        ...
                        <div class="confi">
                            <table width="100%" border="0" cellspacing="0" cellpadding="0" class="" style="float:left; clear:both;">
                                <tr>
                                  <tr>
                                    <td height="40px" style="color:#585858;">Datum: </td>
                                    <td height="40px" style="color:#585858;">Tid: </td>
                                  </tr>	
                                </tr>
                                <tr>
                                    <td class="text-done-1" >
                                        <input type="text" class="form-control text-done select-width-4" name="task_end_day" id="task_end_day" value="<?php echo $task_end_day ?>">
                                </td>
                                <td class="text-done-1">
                                        <input type="text" class="form-control text-done select-width-4" name="task_end_time" id="task_end_time" value="<?php echo $add_hour_minute ?>">
                                </td>
                                  <!--<td>
        ...
        <div class="urgent-task urgent-task-inn">
        	<div class="check-boxes"><input type="checkbox" name="task_urgent" value='1' /></div>
            <div class="urgent-task-1"><div class="Urgent-title">Brådskande</div></div>
            <div class="urgent-task-detail">Jag vill att mitt projekt ska markeras som brådskande. Detta är till uppdrag som ska tilldelas så fort som möjligt.</div>
        </div>
