...
<div>
        ...
        <div class="container">
        	<div class="red-subtitle">Edit Task</div>
                    ...
                    <div class="tabs1">
                    	<div class="left-part">
                            ...
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="step-2-info">
                                    ...
                                    <div class="fl step-2-title">Tell us more about the projec</div>
                                </div>
                            </div>
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="">
                                    <table width="100%" border="0" cellspacing="1" cellpadding="5" style="margin-left:-1px;">
                                        <tr>
                                            <td class="firts_img-1">Uppdragstitel:</td>
                                        </tr>
                                        <tr id="task_nameTR">
                                            <td>
                            ...
                            <div style="visibility: visible; animation-delay: 0.5s; animation-name: fadeIn;" data-wow-delay="0.5s" class="span3 wow fadeIn animated">
                                <div class="">
                                	<table width="100%" border="0" cellspacing="1" cellpadding="5" style="margin-left:-1px;">
                                        <tr>
                                            <td class="firts_img-1">Project descriptio:</td>
                                        </tr>
                                        <tr id="task_nameTR">
                                            <td>
                        ...
                        <div class="right-part">
                            ...
                            <div class="" style="text-align:right;">
                                <input type="submit" name="sub_step1" class="btn btn-default btn-post-btn"  value="Update" style="margin-top:0px;">            
                                <span id="req"></span>
                            </div>
                    	</div>
					</div>
