...
<div id="needhelp-ph">
<p class="needhelp">Your Task So Far</p>
</div>
<div id="right-panel-bg">
		...
		?>
		<div class="estim" style="margin: 0 0 15px 15px;color: #626262;">Deadline:</div>
   	  ...
   	  <ul>
            	<li id="hline" >
					...
					<a href="#" class="fr marR5 chbg1" id="cline">Change</a>
                    <div class="clear"></div>
                </li>
    ...
    <select name="task_end_time" id="task_end_time" class="">
         <option value="60" <?php if($add_hour_minute==60) { ?> selected="selected" <?php } ?>>1 am</option>
		  ...
		  <option value="1440" <?php if($add_hour_minute==1440) { ?> selected="selected" <?php } ?>>midnight</option>
   		...
   		<div class="estim" style="color: #626262;margin: 0 0 15px 15px;">More details:</div>
