...
<table  border="0" cellspacing="1" cellpadding="5">
  <tr id="offer_amountTR">
	<td width="82%">
		<label id="silb" style="color:#585858;"><b>Lägg ett bud (<?php echo $site_setting->currency_symbol;?>)</b></label><br/>
  ...
  <tr id="task_commentTR">
	<td width="82%">
		<label id="silb" style="color:#585858;"><b>Kommentarer </b></label><br/>
   ...
   <tr>
	<td width="82%" style="text-align:center;">
		...
		<input type="submit" value="Lägg bud" class="btn btn-default" name="offerTaskbtn" id="offerTaskbtn">
