<div class="mconright">
    	...
    	<div class="inside-subtitle">Uppskattad kostnad (högsta pris) </div>
...
<table width="100%" cellspacing="1" cellpadding="2" class="st2" style="text-align:left;">
  <tr>
    <td><h4>Betalning :</h4></td>
    <td><h5>Max <?php echo $site_setting->currency_symbol.$task_detail->task_price;
  ...
  <tr>
    ...
    <td><h5>Max <?php echo $site_setting->currency_symbol.$task_detail->extra_cost;
  ...
  <?php } if($task_detail->other_cost>0) { ?>
   <tr>
    ...
    <td><h5>Max <?php echo $site_setting->currency_symbol.$task_detail->other_cost;
  ...
  <tr>
    <td><h4>Total kostnad: </h4></td>
    <td><h5>Max <?php echo $site_setting->currency_symbol.number_format($total_amount,2);?></h5></td>
  </tr>
 
  <tr>
    <td colspan="2" style="padding-top:20px; font-weight:bold; color:#585858;"><span id="req">Betalningen genomförs först när du har godkänt och slutfört uppdraget!</span></td>
  </tr>
</table>
