      ...
      google.maps.event.addDomListener(window, 'load', initialize);
                ...
                <div class="inner_content_two">
                    ...
                    <table width="100%" border="0" cellspacing="1" cellpadding="0">
                      <tr>
                        <td><label>Address</label> <span id="req" style="color:red;">*</span></td>
						<td><input name="address1" id="address1" type="text" size="22"  placeholder="Enter a location" /></td>
                      </tr>
                      <tr>
						<td><label>Postal Code</label> <span id="req" style="color:red;">*</span></td>
						<td><input name="zipcode" id="zipcode" type="text" size="22" placeholder="Postal Code"  />
							<input type="hidden" name="location_state" id="location_state" value=""/>
							<input type="hidden" name="location_city" id="location_city" value=""/>
                        </td>
                      </tr>
                      <tr>
                        <td> <label>Location name</label> <span id="req" style="color:red;">*</span></td>
						<td><input name="locationname" id="locationname" type="text" size="22" placeholder="Home,Sally's,etc"/><?php $location_cnt = 1; ?>
						</td>
                      </tr>
...
<div class="addright" style="float:left; width: 340px;">
...
margin-bottom: 6px;">How much are you willing to pay for this Task?</label>
               ...
               <b class="fs15">From <span id="req" style="color:red;">*</span>&nbsp;&nbsp;&nbsp;</b><span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="task_to_price" id="task_to_price" type="text" size="5" value="<?php if($task_to_price==0.00 || $task_to_price==0) { } else { echo $task_to_price; } ?>" />&nbsp;&nbsp;
 
                
              <b class="fs15">To <span id="req" style="color:red;">*</span>&nbsp;&nbsp;&nbsp;</b> <span id="lesf"><?php echo $site_setting->currency_symbol;?></span><input name="task_price" id="task_price" type="text" size="5" value="<?php  if($task_price==0.00 || $task_price==0) { } else { echo $task_price; } ?>" />
