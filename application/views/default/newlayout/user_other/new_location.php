...
$(document).ready(function(){	
	...
	function validate_sub_newloc()
	{
		...
		form.submit(function(){
			...
			if(validate_location_address() & validate_location_city() & validate_location_state() & validate_location_zipcode())
				return true
			else
				return false;
		});
...
<div>
	...
	<!--<div class="page-title mbot20">
		<h1 class="mleft15">Lägg till adress</h1>
	</div>-->
     <div class="red-subtitle top-red-subtitle" >Lägg till adress</div>
