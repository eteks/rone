...
<div id="success">
<ul>
<?php if($msg=='delete'){ ?> <p>Favourite Runner has been deleted successfully.</p><?php } ?>
</ul></div>
<?php } ?>
...
<div id="s1postJ" class="padB10">Favourite Runners: <?php echo anchor('user/'.getUserProfileName(),$this->session->userdata('full_name'),' class="dhan" ');?></div>
           
           <?php echo anchor('how_it_works','Browse Runners to add a favorite','class="fpass fs14"'); ?>
            	...
            	<div class="abc">
                	...
                	<?php echo anchor('user/'.$row->profile_name,'<img src="'.$user_image.'" alt="" width="50" height="50" />','class="fpass fs14"'); ?>
                     ...
                     ?>
                        ...
                        <a rel="tooltip" class="twoonepts1" title="Level <?php echo $check_worker_detail->worker_level;?> Runner"><?php echo $check_worker_detail->worker_level;?></a>
