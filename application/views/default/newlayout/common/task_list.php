...
<div>
	...
	<h1 class="mleft15">House Chores</h1>
	<div id="dd" class="wrapper-dropdown-3" tabindex="1">
							<p class="subcategories-ph">Sub-Categories</p>
							<ul class="dropdown">
								<li><a href="#">House Cleaning</a></li>
								<li><a href="#">Donation Pickup</a></li>
								<li><a href="#">Laundry</a></li>
								<li><a href="#">Cooking/Backing</a></li>
...
<div id="container-cat" style="display:none; border-bottom:1px solid #E5E4E5; width:638px;">
    <div id="carousel-cat">
