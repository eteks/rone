...
fbq('track', 'CompleteRegistration');
                        ...
                        <div class="inside-task">
                            <div style="visibility: visible; animation-delay: 1s; animation-name: fadeIn;" data-wow-delay="1s" class="span3 wow fadeIn animated">
                                <div class="db-rightinfo login-box-main">
                                    <div class="home-signpost-content home-signpost-content-login"> 
                                        <h1 class="social-login-title" ><b><span style="color:#881926">Gå med i </span> <span style="color:#0e0f19;">Entowork, Bli medlem</span> <span style="color:#881926"> Nu</span></b></h1>
                                        <div class="login-next">
                                         ...
                                         <table width="100%" border="0" cellspacing="0" cellpadding="5" class="fr">
                                              <tr id="full_nameTR">
                                                ...
                                                <input type="text" name="full_name" id="full_name" placeholder="Förnamn *" value="<?php echo $full_name; ?>"  class="ntext form-control form-control-signup icon-back1 form-control-login"  />
                                              ...
                                              <tr id="last_nameTR">
                                                ...
                                                <td width="72%" align="center">
                                                <input type="text" name="last_name" id="last_name" placeholder="Efternamn *" value="<?php echo $last_name; ?>"  class="ntext form-control form-control-signup icon-back1 form-control-login"  />
                          ...
                          <span id="last_nameInfo"></span>
                                              ...
                                              <tr id="zip_codeTR">
                                                ...
                                                <td align="center"><input type="text" name="zip_code" placeholder="Postkod *" id="zip_code"  value="<?php if($this->input->post('zip_code')!="") { echo $this->input->post('zip_code'); } else{ echo $zip_code; } ?>"  class="ntext form-control form-control-signup icon-back2 form-control-login" />
                                              ...
                                              <tr id="mobile_noTR">
                                                ...
                                                <td align="center"><input type="text" name="mobile_no" placeholder="Telefonnummer" id="mobile_no"  value="<?php echo $mobile_no; ?>"  class="ntext form-control form-control-signup icon-back3 form-control-login"  /><span id="mobile_no_symbol" style="float:right; height:37px;"></span><br />
                                              ...
                                              <tr id="passwordTR">
                                                ...
                                                <td align="center"><input type="password" name="password" id="password" placeholder="Lösenord *" value="<?php echo $password; ?>"  class="ntext form-control form-control-signup icon-back5 form-control-login"   /><span id="password_symbol" style="float:right; height:37px;"></span><br />
                                              ...
                                              <tr id="cpasswordTR">
                                                ...
                                                <td align="center"><input type="password" name="cpassword" id="cpassword" placeholder="Bekräfta Lösenord *" value="<?php echo $password; ?>"  class="ntext form-control form-control-signup icon-back5 form-control-login"   /><span id="cpassword_symbol" style="float:right; height:37px;"></span><br />
                                        ...
                                        $site_setting=site_setting();
                                            ...
                                            if($site_setting->captcha_enable==1) { ?>
                                             ...
                                             <!-- <tr>
                                                        ...
                                                        <td> <input type="text" name="captcha"  value="" /><br />(Lösenkoden är känslig för CAPS)</td>
                                                </tr>-->
                                            ...
                                            <?php } ?>
                                              <!--<tr>
                                                ...
                                                <td lign="center"><div id="mbs" ><input type="checkbox" name="agree" id="agree" value="1" />&nbsp;<span class="gen-txt" >Jag accepterar&nbsp;<?php echo anchor('content/terms_of_use','Användarvillkoren', ' style="color:#e23a37"');?></span></div></td>
                                               </tr>
                                                          ...
                                                          <tr>
                                                              <td>
                                                                  <div id="mbs" class="agree-signup agree-login condition_signup">
                                                                      <input type="checkbox" value="1" id="agree" name="agree">&nbsp;<span class="gen-txt">Jag accepterar&nbsp;<a href="<?php echo base_url(); ?>content/terms_and_use" style="font-weight:bold;" id="terms">Användarvillkoren</a></span>
                                                                  </div>   
                                                              </td>
                                                              <td> 
                												...
                												if($f_setting->facebook_login_enable == '1' ||  $t_setting->twitter_login_enable == '1') { ?>
                      											...
                      											<?php /*?>   <a href="<?php echo $data['fbLoginURL']; ?>" class="fbtn"> <img alt="Facebook-16x16" src="<?php echo base_url().getThemeName(); ?>/images/fb.png" class="marB_3 marR5" />Connect to Facebook</a><?php */?>
                                                               	<div style="float:left; width:100%; ">
                                                               		<?php echo anchor(base_url().'index.php/linkedin_signup/initiate','<img src="'.base_url().getThemeName().'/images/fb_signup_btn.png"  alt="" name="sign_fb" onmouseover="this.src=\''.base_url().getThemeName().'/images/fb_signup_btn.png\'" onmouseout="this.src=\''.base_url().getThemeName().'/images/fb_signup_btn.png\'" />'); ?>
                                                               	</div>
	...
	<script type="text/javascript" src="<?php echo base_url().getThemeName(); ?>/js/validation_signup_new.js"></script>
