...
<script type="text/javascript">
	...
	jQuery('.select_city .city').click(function (){			
 	...
 	jQuery('.select_city li a').click(function (){
		...
		jQuery('.select_city .city').text(val);
...
<div class="signup-ph btn btn-default"><a href="<?php echo base_url(); ?>index.php/sign_up">Bli Medlem</a></div>
<div class="login-ph btn btn-default"><a href="<?php echo base_url(); ?>index.php/login">Logga In</a></div>
...
<div class="login-sigup login-sigup-db">
    <div id="flag-ph"><!--<img src="<?php echo base_url().getThemeName()?>/images/flag.jpg">-->
	    <span class="wallet_balance">Mitt Saldo kr <?php echo getwallet_amount() ?></span>
    </div>
</div>
...
<li class="login-user-name"><?php echo $this->session->userdata('full_name'); ?></li>
                     <li class="dropdown-dashboard"><?php echo anchor('dashboard','Översikt');?></li>
                    <li class="dropdown-profile"><?php echo anchor('user/'.getUserProfileName(),'Min Profil');?></li>
                    <li class="dropdown-account"><?php echo anchor('account','Mitt Konto'); ?></li>
                   
                   
                    <li class="dropdown-posttask"><?php echo anchor('user_task/mytasks','Mina Skapade Uppdrag');?></li>
                       <?php 
					
					$check_is_worker=check_is_worker(get_authenticateUserID());
					
					if($check_is_worker) { ?>
                     <li class="dropdown-posttask"><?php echo anchor('worker_task/my','Mina Aktiva Uppdrag');?></li>
                    <?php } ?>
                    
                    
                      <li class="dropdown-alerts"><?php echo anchor('message/allmessage','Meddelanden');?></li>
                      
                   
                    <li class="dropdown-history"><?php //echo anchor('stored_card','Mitt Kreditkort');?></li>
                     <li class="dropdown-history"><?php echo anchor('wallet','Transaktionshistorik');?></li>
                     
                     
                 
                  
                     <li class="dropdown-notification"><?php echo anchor('notifications','Notifikationer');?></li>
                  <li class="dropdown-posttask"><?php echo anchor('user_other/favorites','Mina Favoriter');?></li>
                    <li class="terminal dropdown-logout"><?php 
						if($this->session->userdata('facebook_id') != 0 && $this->session->userdata('facebook_id') != '' )
						{
							...
							echo anchor('home/logout','Logga Ut'); 
						}
					?></li>
...
<div class="rmm login-sigup-2">
                            <ul>
								...
								if($site_setting->subscription_need==0) 
								{
									...
									<a href="<?php echo base_url(); ?>index.php/login">Skapa Uppdrag</a>
									<?php } else { ?>
									<a href="<?php echo base_url(); ?>index.php/task/newhome_task">Skapa Uppdrag</a>
								<?php } 
								}
				                ...
				                <li><a href="<?php echo base_url(); ?>index.php/tags">Aktiva Jobb</a></li>
				                <li><a href="<?php echo base_url(); ?>index.php/how_it_works">Om Entowork</a></li>
                                <li><a href="<?php echo base_url(); ?>index.php/who-are-the-taskers">Medlemskap</a></li>
