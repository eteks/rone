...
$site_setting=site_setting();
 ...
 <h3 id="detail-bg1">Log In</h3>  
	...
	<?php if($msg!='') { if($msg=='login') { ?><div class="error" align="center"><p>Du måste logga in för att kunna skapa ett uppdrag. </p></div><?php } if($msg=='fail') { ?><div class="error" align="center"><p>Sorry,Internal System Error. Please Try Again.</p></div><?php } } ?>
	...
	document.getElementById(id2).style.display = "none";
      ...
      <tr>
		...
		<label style="float:right">
			<input type="checkbox" name="remember" value="1" id="remember" style="margin:0 5px 0 0" />
			<span class="gen-txt">Remember me on this computer</span>
		</label>
		</td>
	  </tr>
      <tr><td height="15px" colspan="2"></td></tr>
