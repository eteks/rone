...
<ul class="padli10">
     <!--   <li><div class="estim marB5">Safety is Task # 1</div>
        ...
        <li>
        	<div class="inside-subtitle inside-subtitle-2">Visa Entoworkers i:  </div>
        	    	<?php 
						if($cityname == 'all') {
                ...
                <?php
				  ...
				  $cityi=0;
					...
					{	?>
						...
						?> 
          		 <?php } $cityi++; } } ?>
				 <p style="float:left; width:100%; text-align:center; font-family:arial; font-size:12px; margin:15px 0 0 0""><?php echo anchor('category/city','Visa alla områden','class="btn btn-default"');?></p>
                <div class="clear"></div>
        </li>
      <style>
	  a.btn_less{
		...
		<li>&nbsp;</li>
        <li>
        	<div class="inside-subtitle inside-subtitle-2">Visa Entoworkers efter kompetenser</div>
        	<ul class="accr" id="list">  
				...
				?>
				 ...
				 <a href="javascript:void(0)" class="btn_more btn btn-default">Visa mer</a>
				 <a href="javascript:void(0)" class="btn_less btn btn-default">Visa mindre</a>
				 </p>
