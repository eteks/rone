...
<!--banner ends-->
        ...
        function append_div2()
        {
            ...
            if(glry_cnt<5)
            {
                ...
                var str = '<div onclick="remove_gallery_div('+num+')" class="fr" style="text-align:left;float:left !important;font-weight:bold;cursor:pointer;color:#990000;">Remove</div><div class="clear"></div>';			
            ...
            function validate_apply()
            {
                ...
                {	
                    if(worker_cities.val()=='')
                    {
                        ...
                        worker_citiesInfo.text("Vänligen välj område!");
		...
		?>
        <div class="red-subtitle top-red-subtitle">Formulär för Entoworker: <?php echo $this->session->userdata('full_name'); ?></div>
    	<div class="profile_back">
            <div class="container" style="padding-top:20px; padding-bottom:20px;">
                <div class="" style="background:#e7e7e7 !important; overflow:hidden;">
                    <div class="">
                        <!--<ul class="appul">
                        	<h1 class="social-login-title" style="margin-top:75px; margin-bottom:20px;"><b>Välkommen till vår verifikationsprocess!</b></h1>
                            <li>
                            	<div class="container">
                        ...
                        <div class="container data-info">
                                ...
                                <div class="right-block" style="float:left; padding-left:25px;">
                                    <ul class="appul">                   
                                        ...
                                        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1">
                                            ...
                                            <tr>
                                                <td width="25%" style="float:left;"><h4>Telefonnummer : </h4></td>
                            ...
                            <div class="span3 wow fadeInRight center animated animated" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
                                <div class="left-block left-block-15" style="float:right; padding-right:25px;">
                                    <ul class="appul">
                                        <li>
                                            <h3 class="home-title">Adress</h3>
                                            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1">
                                               <tr>
                                                <td width="25%" style="float:left;"><h4>Plats <span id="req" style="color:red;">*</span> : </h4></td>
                                              ...
                                              <tr>
                                                <td width="25%" style="float:left;"><h4>Län <span id="req" style="color:red;">*</span> : </h4></td>
                            ...
                            <ul class="appul" style="margin-top:0px; padding-left:25px; padding-right:25px;">
                                <li>
                                	...
                                	<table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1">
                                      ...
                                      <tr>
                                        <td colspan="2">
                                            <h4 class="home-title home-title-2">Vänligen välj områden du vill jobba inom, du kan givetvis välja flera områden!</h4><br />
                                        </td>
                                    </tr>
                                      <tr>
                                      ...
                                      <tr>
                                          <td width="12%" style="float:left; padding-top:10px; color:#565656"><h4>Områden : </h4></td>
                                      ...
                                      <div class="clear"></div>
                                          <span id="req" style="color:red; margin-left:-11px;">*</span><span style="font-weight:normal; font-size:14px;">(Du kan välja flera genom att hålla inne CTRL)</span>
                                    ...
                                    <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1">
                                      ...
                                      <tr>
                                        <td>
                                        <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                        <h4 style="float:left;" class="question">1. Vilka transportmedel kommer du att använda för uppdragen? <span id="req" style="color:red;">*</span></h4><p id="worker_transportation_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_transportationInfo" style="display:block;"></span>
                                        <ul class="apque">
                                            <?php 
                                      ...
                                      <tr>
                                        <td>
                                        <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                            <h4 class="question">2. Kort CV - Skriv lite om dig själv och dina tidigare arbeten. <span id="req" style="color:red;">*</span></h4>
                                      ...
                                      <tr>
                                        ...
                                        $post_worker_available_day=array();
                                                ...
                                                ?>
                                                <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                        <h4 style="float:left;" class="question">3. Vilka veckodagar är du vanligtvis tillgänlig på? <span id="req" style="color:red;">*</span></h4><p id="worker_available_day_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_available_dayInfo" style="display:block;"></span>
                                        	<br />
                                      ...
                                      <tr>
                                        ...
                                        $post_worker_available_time=array();
                                           ...
                                           <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">     
                                        <h4 style="float:left;" class="question">4. Vilken tid på dagen? <span id="req" style="color:red;">*</span></h4><p id="worker_available_time_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_available_timeInfo" style="display:block;"></span>
                                        <ul class="apque">
                                    ...
                                    <ul class="apque">
                                      ...
                                      <tr>
                                        <td>
                                        <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                        <h4 class="question">5.Personnummer (frivilligt, men gör det lättare för oss att verifiera dig)</h4>
                                            <ul class="apque">
                                      ...
                                      <tr>
                                        <td>
                                        <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                        <h4 class="question"> Bifoga ditt CV (Frivilligt) </h4>
