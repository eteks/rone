	...
	if(bgchk==true)
	{
        ...
        for (var i = 0; i < chks.length; i++)
        {
                if (chks[i].value=='')
                {
						...
						dv.style.margin = "5px";
						dv.innerHTML ='<ul><p>Du måste välja en fil!</p></ul>';
				...
				{						
						...
						if( t1=='jpg' || t1=='jpeg' || t1=='gif' || t1=='png' || t1=='JPEG' || t1=='JPG'  ||  t1=='PNG' || t1=='GIF' || t1=='pdf' || t1=='PDF' || t1=='doc' || t1=='DOC' || t1=='docx' || t1=='DOCX')
						{
							document.getElementById('err1').style.display='none';
							check=true;
						}
						...
						{							
							...
							dv.style.minWidth = "110px";
							dv.style.margin = "5px";
							dv.innerHTML = '<ul><p>Det bifogade filformatet stöds inte.</p></ul>';
							dv.style.display='block';
							hasChecked = true;							
...
$(document).ready(function(){
	...
	function validate_apply()
	{
		...
		form.submit(function(){
			if(validate_worker_cities() & validate_worker_location_name() & validate_worker_zipcode() &  validate_worker_address() & validate_worker_city() & validate_worker_state()  & validate_worker_task_type() & validate_worker_transportation() & validate_worker_skills()  & validate_worker_available_day() & validate_worker_available_time())
				return true
			else
				return false;
		});
		...
		<?php 
			...
			$attributes = array('name'=>'workerApplyForm','id'=>'workerApplyForm','class'=>'form_design','style'=>'float: left;padding-left: 0;width: 100%;','onsubmit'=>'return submitattachment_valid()');
			echo form_open_multipart('worker/apply',$attributes);
		?>
        <div class="red-subtitle top-red-subtitle">Formulär för:  <?php echo $this->session->userdata('full_name'); ?></div>
    	<div class="profile_back">
        <div class="container" style="padding-top:20px; padding-bottom:20px;">
        <div class="" style="background:#e7e7e7 !important; overflow:hidden;">
        <div class="">
			<!--<ul class="appul">
			...
			<div class="clear"></div>
            <div class="red-subtitle top-red-subtitle">Sektion 1</div>
            <ul class="appul">
                <li>   
                    <?php if($error != '') { ?>     
                    <div id="error"> 
            ...
            <div class="container data-info">
                <div class="span3 wow fadeInRight center animated animated" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInRight;">
                    <div class="right-block" style="float:left; padding-left:25px;">
                        <ul class="appul">                   
                            <li>
                                <h3 class="home-title">Detaljer från ditt <a href="<?php echo base_url(); ?>account">konto</a></h3>
                            </li>
                            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1">
                                ...
                                <tr>
                                    <td width="25%" style="float:left;"><h4>Förnamn: </h4></td>
                                ...
                                <tr>
                                    <td width="25%" style="float:left;"><h4>Efternamn: </h4></td>
                                ...
                                <tr>
                                    <td width="25%" style="float:left;"><h4>Telefon: </h4></td>
                ...
                <div class="span3 wow fadeInLeft center animated animated" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInLeft;">
                    <div class="left-block left-block-15" style="float:right; padding-right:25px;">
                        <ul class="appul">
                            <li>
                                <h3 class="home-title">Lägg till adress</h3>
                                <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1 apptab1-3">
                                   <tr>
                                    <td width="25%" style="float:left;"><h4>Titel <span id="req" style="color:red;">*</span> : </h4></td>
                                    <td width="54%" style="float:left;"><input name="worker_location_name" id="worker_location_name" type="text" class="ntexttf form-control" value="<?php echo $worker_location_name; ?>" style="width:300px;"/><span id="worker_location_name_symbol" style="float:right; height:20px;"></span><br /><span id="worker_location_nameInfo" style="height:20px; display:block;"></span></td>
                                  </tr>
                                  
                                  <tr>
                                    <td width="25%" style="float:left;"><h4>Postkod <span id="req" style="color:red;">*</span> : </h4></td>
                                    <td width="54%" style="float:left;"><input name="worker_zipcode" id="worker_zipcode" type="text" class="ntexttf form-control" value="<?php echo $worker_zipcode; ?>" style="width:300px;"/><span id="worker_zipcode_symbol" style="float:right; height:20px;"></span><br /><span id="worker_zipcodeInfo" style="height:20px; display:block;"></span></td>
                                  </tr>
                                  
                                   <tr>
                                    <td width="25%" style="float:left;"><h4>Adress <span id="req" style="color:red;">*</span> : </h4></td>
                                    <td width="54%" style="float:left;"><input name="worker_address" type="text" class="ntexttf form-control" value="<?php echo $worker_address; ?>" id="worker_address" style="width:300px;"/><span id="worker_address_symbol" style="float:right; height:20px;"></span><br /><span id="worker_addressInfo" style="height:20px; display:block;"></span></td>
                                  </tr>
                                  
                                  <tr>
                                    <td width="25%" style="float:left;"><h4>Stad <span id="req" style="color:red;">*</span> : </h4></td>
                                    <td width="54%" style="float:left;"><input name="worker_city" type="text" class="ntexttf form-control" value="<?php echo $worker_city; ?>" id="worker_city" style="width:300px;"/><span id="worker_city_symbol" style="float:right; height:20px;"></span><br /><span id="worker_cityInfo" style="height:20px; display:block;"></span></td>
                                  </tr>
                                  
                                  <tr>
                                    <td width="25%" style="float:left;"><h4>Land <span id="req" style="color:red;">*</span> : </h4></td>
                                    <td width="54%" style="float:left;">
                                    <input name="worker_state" type="text" class="ntexttf form-control" value="<?php echo $worker_state; ?>" id="worker_state" style="width:300px;"/><span id="worker_state_symbol" style="float:right; height:20px;"></span><br /><span id="worker_stateInfo" style=" display:block;"></span>
                                  </tr>
                                 ...
                                 <!-- <tr>
                                  ...
                                  <table width="100%" border="0" cellspacing="1" cellpadding="5">
                                  		<tr>
                                    	<td class="selhov" colspan="2">
                                      		<label>
                                        		<input type="checkbox" name="save_location" class="locatol" value="1" id="save_location" <?php if($save_location==1) { ?> checked="checked" <?php } ?> />
                                        		Spara denna plats
                                           </label>
                                           <br />
                                           <br />
            ...
            <div class="clear"></div>
            <div class="red-subtitle top-red-subtitle">Sektion 2</div>
            <div class="container data-block-2">
                <ul class="appul" style="margin-top:0px; padding-left:25px;">
                    <li>
                    	<div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1 apptab1-1">
								...
								function get_city(city_id)
								{
										...
										jQuery.ajax({
										            ...
										            success:function(list){
										                if(list.search(/\S/)!=-1){
										                    list1 = '<option value="">Välj Stad</option>'+list;
                                ...
                                <tr>
                                	<td colspan="2">
                                    	<h4 class="home-title home-title-2">Vänligen välj vilka områden du vill jobba inom. Du kan givetvis välja flera!</h4><br />
                                    </td>
                                </tr>
                                <tr>
                                    <td width="12%" style="float:left; padding-top:6px; color:#565656;"><h4>Stad: </h4></td>
                                    <td width="54%" style="float:left;">
                                        <select name="task_state_id" id="task_state_id" class="selboxwi200 form-control" style="margin-bottom:0px; width:200px; float:left" onchange="get_city(this.value)">
                                            <option value="" >--Välj stad/kommun--</option>
                                            <?php 
                                                if($state_list){
                                ...
                                <tr>
                                    <td width="12%" style="float:left; padding-top:6px; color:#565656;"><h4>Områden: </h4></td>
                                ...
                                <div class="clear"></div>
                                <span id="req" style="color:red; text-align:left; margin-left:-11px;">*</span><span style="font-weight:normal; font-size:14px;">(Du kan välja flera genom att hålla inne CTRL/CMD)</span>
                                ...
                                <tr>
                                      <td width="12%" style="float:left; padding-top:6px; color:#565656;"><h4>Distans <span id="req" style="color:red;">*</span> : </h4></td>
                                      <td width="54%" style="float:left;">
                                      <select name="worker_home_neighborhood" id="worker_home_neighborhood" class="form-control select-control">
                                          <option value="" <?php if($worker_home_neighborhood=="") echo 'selected'; ?>>--Välj--</option>
                                          <option value="1" <?php if($worker_home_neighborhood==1) echo 'selected'; ?>>Upp till 10 kilometer</option>
                                          <option value="2" <?php if($worker_home_neighborhood==2) echo 'selected'; ?>>Upp till 20 kilometer</option>
                                          <option value="3" <?php if($worker_home_neighborhood==3) echo 'selected'; ?>>Upp till 30 kilometer</option>
                        ...
                        <table width="100%" border="0" cellspacing="1" cellpadding="5" class="apptab1">
                           <tr>
                            ...
                            <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <h4 class="home-title home-title-2">Välj vilka arbetsområden du vill få notiser från när någon skapar ett passande uppdrag. Du kan alltid ändra detta senare!<span id="req" style="color:red;">*</span></h4><br />
                        
                             <a href="javascript:void(0)" onclick="javascript:setchecked('worker_task_type[]',1)" class="btn btn-default">Markera alla</a> ,  <a href="javascript:void(0)" onclick="javascript:setchecked('worker_task_type[]',0)" class="btn btn-default">Avmarkera alla</a><span id="worker_task_type_symbol" style="float:right; height:20px; margin-right:740px;"></span><span id="worker_task_typeInfo" style="height:20px;padding-top:10px; display:block;"></span>
                                    ...
                                    if($worker_task_type)
                                    {
                                        ...
                                        if($categories) { 
                                            foreach ($categories as $category){
                                                ...
                                                echo '<li style="margin-bottom:10px; width:auto;"><label style="background: #881926; color: #fff; cursor: pointer; display: block; font-size: 14px;  margin: 0; padding: 10px;"><input name="worker_task_type[]" id="worker_task_type" type="checkbox" value="'.$category->task_category_id.'" '.$checked.' /> '.$category->category_name.'</label></li>';
                                                if($cou == 6)
                                                {
                          ...
                          <tr>
                            <td>
                            <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <h4 style="float:left;" class="question">1. Vilka transportmedel kommer du använda dig utav när du ska utföra uppdrag? <span id="req" style="color:red;">*</span></h4><p id="worker_transportation_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_transportationInfo" style="display:block;"></span>
                            <ul class="apque">
                                <?php 
                          ...
                          <tr>
                            <td>
                            <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                <h4 class="question">2.Berätta lite om dig själv. Beskriv varför uppdragsgivare ska välja just dig! <span id="req" style="color:red;">*</span></h4>
                          ...
                          <tr>
                            ...
                            $post_worker_available_day=array();
                                    ...
                                    ?>
                                    <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <h4 style="float:left;" class="question">3. Vilka dagar är du oftast tillgänglig på? <span id="req" style="color:red;">*</span></h4><p id="worker_available_day_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_available_dayInfo" style="display:block;"></span>
                            <br />
                            ...
                            <ul class="apque">
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Sunday" id="worker_available_day" <?php if(in_array('Sunday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Söndag</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Monday" id="worker_available_day" <?php if(in_array('Monday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Måndag</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Tuesday" id="worker_available_day" <?php if(in_array('Tuesday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Tisdag</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Wednesday" id="worker_available_day" <?php if(in_array('Wednesday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Onsdag</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Thursday" id="worker_available_day" <?php if(in_array('Thursday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Torsdag</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Friday" id="worker_available_day" <?php if(in_array('Friday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Fredag</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_day[]" value="Saturday" id="worker_available_day" <?php if(in_array('Saturday',$post_worker_available_day)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Lördag</label></li>
                            </ul>
                            </div>
                            </td>
                          </tr> 
                          ...
                          <tr>
                            ...
                            $post_worker_available_time=array();
                               ...
                               <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">     
                            <h4 style="float:left;" class="question">4. Vilken tid på dagen är du tillgänglig? <span id="req" style="color:red;">*</span></h4><p id="worker_available_time_symbol" style="float:left; height:12px; padding-left:10px;"></p><span id="worker_available_timeInfo" style="display:block;"></span>
                            <ul class="apque">
                                <li><label><input type="checkbox" name="worker_available_time[]" value="Morning" id="worker_available_time" <?php if(in_array('Morning',$post_worker_available_time)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Morgonen</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_time[]" value="Midday" id="worker_available_time" <?php if(in_array('Midday',$post_worker_available_time)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;På dagen</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_time[]" value="Afternoon" id="worker_available_time" <?php if(in_array('Afternoon',$post_worker_available_time)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Eftermiddagen</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_time[]" value="Evening" id="worker_available_time" <?php if(in_array('Evening',$post_worker_available_time)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Kvällen</label></li>
                                
                                <li><label><input type="checkbox" name="worker_available_time[]" value="Last Night" id="worker_available_time" <?php if(in_array('Last Night',$post_worker_available_time)){  echo 'checked="checked"';} ?>/>&nbsp;&nbsp;Natten</label></li>
                            </ul>
                            </div>
                            </td>
                          </tr> 
                        ...
                        <ul class="apque">
                          ...
                          <tr>
                            <td>
                            <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                            <h4 class="question">5. Personnummer (Frivilligt, men underlättar verifieringen för oss)</h4>
                                <ul class="apque">
                                            <li><input type="text" name="worker_securitynum" class="form-control" /></li>
                                            </ul>
                                </div>
                            </td>
                          </tr> 
                          ...
                          <tr>
                                        <td>
                                        	<table cellpadding="0" cellspacing="0" width="100%">
                                            	<tr>
                                                	<td width="10%" valign="middle" class="birth-title"><h4 class="question" style="margin-top:-17px;">Födelsedatum : </h4></td>
                                            ...
                                            <li style="width:100%">
                                                ...
                                                <option value="1" <?php if($bobmonth == '1'){ echo 'selected';} ?>>Januari</option>
                                                <option value="2" <?php if($bobmonth == '2'){ echo 'selected';} ?>>Februari</option>
                                                <option value="3" <?php if($bobmonth == '3'){ echo 'selected';} ?>>Mars</option>
                                                <option value="4" <?php if($bobmonth == '4'){ echo 'selected';} ?>>April</option>
                                                <option value="5" <?php if($bobmonth == '5'){ echo 'selected';} ?>>Maj</option>
                                                <option value="6" <?php if($bobmonth == '6'){ echo 'selected';} ?>>Juni</option>
                                                <option value="7" <?php if($bobmonth == '7'){ echo 'selected';} ?>>Juli</option>
                                                <option value="8" <?php if($bobmonth == '8'){ echo 'selected';} ?>>Augusti</option>
                                                <option value="9" <?php if($bobmonth == '9'){ echo 'selected';} ?>>September</option>
                                                <option value="10" <?php if($bobmonth == '10'){ echo 'selected';} ?>>Oktober</option>
                          ...
                          <tr>
                                        <td>
                                        <div class="span3 wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                                        <h4 class="question"> Bifoga ditt CV (Valfritt) </h4>
                                ...
                                <?php $dcnt=1;
                                    ...
                                    <?php $dcnt++;    }  }  } ?>
                                         <div id="more2">
                                              ...
                                              <div class="fl">Bifoga en fil  </div>                        
                          ...
                          <div class="clear"></div>
                          <p style="margin-top:15px;"><span class="colora"><b>Observera:</b></span> Endast PDF, PNG, JPG, GIF filer är tillåtna. Vi är inte Google :)<br /><br /></p>
                          </td>
                          </tr>
                          <tr>
                            <td height="15"></td>
            ...
            <div class="clear"></div>
            <div class="red-subtitle top-red-subtitle" style="font-size:15px; margin-bottom:25px;">
                <div class="container" style="text-align:center; text-transform:none;">
                    Vi har ofta en väntelista för ansökan till att bli en Entoworker. Vi försöker att hantera alla medlemskap så fort vi kan och jobbar utefter de resurser vi har. Vi jobbar hela tiden mot att kunna leverera vår tjänst snabbare och på ett bättre sätt. Desto mer fullständig information du fyller i, desto lättare blir det för oss att hantera din förfrågan... 
Vi kontaktar dig så fort vi är klara!
                </div>
            </div>
            <div class="area-ph" style="text-align:center; margin-bottom:30px;"> 
                <input type="submit" name="worker_apply" class="btn btn-default btn-default-join btn-app" id="apply" value="Ansök">   
            </div>
