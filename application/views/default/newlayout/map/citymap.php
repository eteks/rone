...
<div class="become-tasker become-tasker-12" style="padding: 30px 0; ">
    <div class="container">
        <div class="span3 wow fadeIn animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
            ...
            <p class="only-text" style="text-align:left; color:#fff;">3. 
För mer detaljer om ett specifikt jobb så klicka på uppdragstiteln så kommer du till annonsen och kan buda eller kopiera uppdraget.</p>
        </div>
    </div>
</div>
    <div class="clear"></div>
