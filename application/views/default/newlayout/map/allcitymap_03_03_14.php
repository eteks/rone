...
<div class="mapatleft">
			<div style="width:100%; padding:5px 0px 0px 0px; height:40px; background-color:#E1E1E1;">
				...
				Select Category in : &nbsp;&nbsp;<select name="catmap" id="catmap">
				<option value="all">All</option>
				<?php foreach($all_categories as $all_cats) { ?>
				<option value="<?php echo $all_cats->task_category_id;?>"><?php echo $all_cats->category_name;?></option>
				<?php } ?>
				</select>
				</div>
				<div class="clear"></div>
