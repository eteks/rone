...
<!--banner-->
<div class="red-subtitle top-red-subtitle">Sök uppdrag via kartan</div>
	...
	<div class="become-tasker become-tasker-12" style="padding: 30px 0; ">
        <div class="container">
            <div class="span3 wow fadeIn animated animated" data-wow-delay="0.4s" style="visibility: visible; animation-delay: 0.4s; animation-name: fadeIn;">
                <p class="only-text" style="text-align:left; color:#fff;">1. Hitta intressanta uppdrag eller få inspiration till att skapa ett eget uppdrag!</p> 
                <p class="only-text" style="text-align:left; color:#fff;">2. Skrolla ner i listan och klicka på uppdragen du vill veta mer om. Klicka på jobbet för att se det på kartan.</p>
                <p class="only-text" style="text-align:left; color:#fff;">3. För mer detaljer om ett specifikt jobb så klicka på uppdragstiteln så kommer du till annonsen och kan buda eller kopiera uppdraget.</p>
            </div>
        </div>
    </div>
    <div class="clear"></div>
                         ...
                         ch:[
                                ...
                                {el:'div',att:{id:'leftPane1'},
                                    ...
                                    <?php if($task_activity_status==0) { ?>
                                            ...
                                            {el:'p',ch:[{txt:'ska vara utförd tills'}]},
                                            ...
                                            ch:[
                                                {txt:'Prissättning: '},{el:'span',att:{'class':'colora1'},ch:[{txt:'<?php echo  mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_to_price.' - '.mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price;?>'}]}
                                                ]
                                            }
                                            ...
                                            ch:[
                                                {txt:'Prissättning: '},{el:'span',att:{'class':'colora1'},ch:[{txt:'<?php echo mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').' - '.mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price;?>'}]}
                                                ]
                                            }
                                            ...
                                            ch:[
                                                {txt:'Prissättning: '},{el:'span',att:{'class':'colora1'},ch:[{txt:'<?php echo mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price.' - '.mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price;?>'}]}
                                                ]
                                            }
            ...
            el:'dl',ch:[
                    ...
                    {el:'dt',att:{'class':'fl wid160'},ch:[														  
                                    ...
                                    <?php if($task_activity_status==0) { ?>
                                            ...
                                            ch:[
                                                {txt:'Tasks of this type: '},{el:'span',att:{'class':'colora1'},ch:[{txt:'<?php echo mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_to_price.' - '.mb_convert_encoding($site_setting->currency_symbol, 'UTF-8', 'HTML-ENTITIES').$tasklist->task_price;?>'}]}
                                                ]
        ...
        <div class="dbleft dbleft-map">
            <div class="dbleft-map-inner">
                ...
                <table cellpadding="0" cellspacing="0" class="apptab1 apptab1-1" align="center">
                    <tr>
                      	<td width="34%" style="float:left; padding-top:2px; font-size:20px; color: #fff;"><h4>Välj Område: </h4></td>
            ...
            //alert(val);
              ...
              alert(myURL);
				...
				<div class="dbright-task dbright-task-map">
                	<div class="map-title">Jobb</div>
                    <div class="clear"></div>
                    <ul id="markerList" style="border-radius:0 5px 5px 0px; height:514px !important;">
