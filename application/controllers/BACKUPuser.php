...
class User extends ROCKERS_Controller 
{
	...
	function make_favorite($user_id)
	{
		...
		else
		{
			...
			?>
              ...
              <input name="" type="submit" class="myfavbtnbg" onClick="un_favorite(<?php echo $user_id;?>)" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; My Favorite" />
	...
	function un_favorite($user_id)
	{
		...
		else
		{
			...
			?>
             ...
             <input name="" type="submit" class="favbtnbg" onClick="make_favorite(<?php echo $user_id;?>)" value="&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Add as Favorite" />
	...
	*/
	...
	function customize_profile($msg='')
	{
		...
		$this->form_validation->set_rules('current_city', 'My City', 'required|numeric');
