...
$opts = array(
	'root'            => 'c://wamp/www/taskrobo/editor/files',                       // path to root directory
	'URL'             => 'http://localhost/taskrobo/editor/files/', // root directory URL. It is best to set this to an absolute path.
	
	//'root'            => '/home/rockers/public_html/GROUPFUND.ME/taskrobo/editor/files',                       // path to root directory
	//'URL'             => 'http://groupfund.me/taskrobo/editor/files/', // root directory URL. It is best to set this to an absolute path.
